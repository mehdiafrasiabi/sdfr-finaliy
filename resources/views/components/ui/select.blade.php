...
>
    ...
    <div
        ...
        class="absolute z-50 {{ $dropUp ? 'bottom-full mb-1' : 'mt-1' }} w-full rounded-xl overflow-hidden border border-gray-200 dark:border-gray-600 bg-secondary shadow-xl shadow-black/10 dark:shadow-black/50"
        style="min-width: 100%"
        role="listbox"
    >
        @if($searchable)
        ...
        <div class="max-h-56 overflow-y-auto py-1" role="listbox">
            ...
            <div x-show="filtered.length === 0" class="px-3 py-4 text-center text-xs text-gray-400 dark:text-gray-500">
                نتیجه‌ای یافت نشد
            </div>
        </div>
    </div>
