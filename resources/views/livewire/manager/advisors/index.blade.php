        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title mb-0">لیست مشاور ها</h4>
                </div>
                        ...
                        <div class="row g-4 mb-3">
                            ...
                            <form wire:submit.prevent="export" class="me-2">
                                <button type="submit" class="btn btn-success btn-sm">
                                    <i class="ri-download-2-fill align-middle me-1"></i> خروجی اکسل مشاورها
                                </button>
                            </form>
                        </div>
                        ...
                        <div class="table-responsive table-card mt-3 mb-1">
                            <table class="table align-middle table-nowrap" id="customerTable">
                                ...
                                @forelse($advisors as $advisor)
                                    <tr>
                                        <th scope="row">
                                            {{$loop->iteration + $advisors->firstItem() - 1}}
                                        </th>
                                        <td class="customer_name">{{ $advisor->name }}</td>
