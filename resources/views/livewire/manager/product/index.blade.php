        ...
        <div class="card-header border-0">
            <div class="row g-4">
                <div class="col-sm-auto">
                    <div>
                        <a href="{{route('manager.product.create')}}" class="btn btn-info" id="addproduct-btn"><i
                                class="ri-add-line align-bottom me-1"></i>افزودن
                            محصول</a>
                    </div>
                </div>
                <div class="col-sm">
                    <div class="d-flex justify-content-sm-end">
                        <div class="search-box ms-2">
                            <input type="text" wire:model.live.debounce.350ms="search" name="search" class="form-control" id="searchProductList"
                                   placeholder="جستجوی محصولات براساس نام کاربر و کد محصول">
                ...
                <div class="col">
                    <ul class="nav nav-tabs-custom card-header-tabs border-bottom-0" role="tablist">
                        <li class="nav-item" role="presentation">
                            <a class="nav-link text-body active fw-semibold" data-bs-toggle="tab" href="#productnav-all"
                               role="tab" aria-selected="true">همه<span
                                    class="badge bg-danger-subtle text-danger align-middle rounded-pill ms-1">12</span>
                            </a>
                        </li>
                        <li class="nav-item" role="presentation">
                            <a class="nav-link text-body fw-semibold" data-bs-toggle="tab" href="#productnav-published"
                        ...
                        <div role="complementary" class="gridjs gridjs-container" style="width: 100%;">
                                ...
                                <table role="grid" class="gridjs-table" style="height: auto;">
                                    ...
                                    <tr class="gridjs-tr">
                                        ...
                                        <th data-column-id="published" class="gridjs-th gridjs-th-sort text-muted"
                                            ...
                                            <div class="gridjs-th-content">قیمت</div>

                                        </th>
                                        <th data-column-id="published" class="gridjs-th gridjs-th-sort text-muted"
                                            tabindex="0" style="width: 220px;">
                                            <div class="gridjs-th-content">محتوای محصول</div>
                                    ...
                                    @forelse($products as $product)
                                        <tr class="gridjs-tr">
                                                ...
                                                <span>
                                                    <div
                                                        ...
                                                        <div
                                                            ...
                                                            <div
                                                                class="avatar-sm bg-light rounded p-1"><img
                                                                    src="/products/{{$product->id}}/photo/{{@$product->coverImage->path}}"
                                                                    alt="{{$product->name}}"
                                                        ...
                                                        <div
                                                            class="flex-grow-1"><h5 class="fs-14 mb-1"><a
                                                                    ...
                                                                    class="text-body"> {{$product->name}}</a></h5><p
                                                                class="text-muted mb-0">کد محصول : <span
                                                                    class="fw-medium"> {{$product->p_code}}</span>
                                                            </p>
                                                        </div>
                                                    </div>
                                                </span>
                                            </td>
                                            <td data-column-id="stock" class="gridjs-td">{{@$product->course_time}}</td>
                                            <td data-column-id="price" class="gridjs-td"><span>{{@$product->meeting_time}}</span></td>
                                            <td data-column-id="orders" class="gridjs-td">{{@$product->tag}}</td>
                                            <td data-column-id="rating" class="gridjs-td"><span><span
                                                        class="badge bg-light text-body fs-12 fw-medium"><i
                                                            class="mdi mdi-star text-warning me-1"></i>{{@$product->category->name}}</span></span>
                                            </td>

                                            <td data-column-id="published" class="gridjs-td"><span>{{number_format($product->price)}}<small
                                                        class="text-muted ms-1"></small></span></td>

                                            <td data-column-id="rating" class="gridjs-td"><span><a href="{{route('manager.product.content',$product->id)}}"
                                                                                                   class="badge bg-light text-body fs-12 fw-medium"><i
                                                            class="mdi mdi-star text-warning me-1"></i>محتوا</a></span>
                                            </td>
                                            ...
                                            <td data-column-id="action" class="gridjs-td"><span><div class="dropdown"><button
                                                            ...
                                                            class="dropdown-menu dropdown-menu-end"><li><a
                                                                    class="dropdown-item"
                                                                    href="apps-ecommerce-product-details.html"><i
                                                                        class="ri-eye-fill align-bottom me-2 text-muted"></i> View</a></li><li><a
                                                                    class="dropdown-item edit-list" data-edit-id="1"
                                                                    href="{{route('manager.product.create')}}?product_id={{$product->id}}"><i
                                                                        class="ri-pencil-fill align-bottom me-2 text-muted"></i> ویرایش</a></li><li
                            ...
                            <div class="gridjs-footer">
                                <div class="gridjs-pagination">
                                    ...
                                    {{$products->links('layouts.manager.pagination')}}
