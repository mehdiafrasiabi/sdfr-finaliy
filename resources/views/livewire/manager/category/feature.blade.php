        ...
        <div class="col-xxl-6">
            ...
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1">ویژگی دسته بندی
                    ...
                    <div class="live-preview">
                        <form wire:submit="submit(Object.fromEntries(new FormData($event.target)))">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="name" class="form-label">ویژگی:</label>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title mb-0">لیست ویژگی های دسته بندی
                            <span wire:ignore style="color: #29971d">{{$categoryName}}</span>
                            ...
                            <div class="row">
                                <div class="table-responsive table-card mb-4">
                                    <table id="alternative-pagination"
                                        ...
                                        @forelse($categoryFeatures as $categoryFeature)
                                            <tr class="odd">
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center fw-medium">
                                                        <a href="javascript:void(0);"
                                                           class="currency_name">{{ $categoryFeature->name }}</a>
                                                    </div>
                                                </td>
                                                ...
                                                <td>
                                                    <button
                                                        wire:click="edit({{$categoryFeature->id}})"
                                    ...
                                    {{$categoryFeatures->links('layouts.manager.pagination')}}
