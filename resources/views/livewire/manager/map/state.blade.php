        ...
        <div class="col-xxl-6">
            ...
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1">مدیرت استان ها</h4>

                </div><!-- end card header -->

                <div class="card-body">
                    <p class="text-muted">
                        در این قسمت میتوانید استان هایی که با مجموعه قرار دارند اضافه یا حذف نمود
                    </p>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" wire:model="name" name="name" class="form-control"
                                               placeholder="مثلا:ایران" id="name">
                                        @error('name') <span class="text-danger text-sm">{{ $message }}</span> @enderror
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="countryId" class="form-label">انتخاب کشور مربوطه:</label>
                                        <sup style="color: red">*</sup>
                                        <select name="countryId" wire:model="countryId2" class="form-select mb-3" wire:ignore>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title mb-0">لیست استان های تحت مجموعه </h5>
                    </div>
                    <div class="card-body">
                        <div id="alternative-pagination_wrapper" class="dataTables_wrapper dt-bootstrap5 no-footer">
                                    ...
                                    <div class="d-flex justify-content-sm-end">
                                        <div class="search-box ms-2">
                                            <input wire:model.live.debounce.500ms="search" type="text"
                                                   class="form-control search" placeholder="جستجو بر اساس نام استان">
                            ...
                            <div class="row">
                                <div class="table-responsive table-card mb-4">
                                    <table id="alternative-pagination"
                                        ...
                                        <tr>
                                            ...
                                            <th  tabindex="0" aria-controls="alternative-pagination"
                                                 ...
                                                 aria-label="نام درگاه دریافتی: activate to sort column ascending"> استان
                                            </th>
                                            <th  tabindex="0" aria-controls="alternative-pagination"
                                                 rowspan="1" colspan="1" style="width: 183.661px;"
                                                 aria-label="نام درگاه دریافتی: activate to sort column ascending"> کشور مربوطه
                                            </th>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center fw-medium">
                                                        <a href="javascript:void(0);"
                                                           class="currency_name">{{ $state->name }}</a>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="d-flex align-items-center fw-medium">
                                                        <a href="javascript:void(0);"
                                                           class="currency_name">{{ $state->country->name }}</a>
                                                    </div>
                                                </td>
                                    ...
                                    {{$states->links('layouts.manager.pagination')}}
