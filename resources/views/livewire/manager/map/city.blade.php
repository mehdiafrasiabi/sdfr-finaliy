        ...
        <div class="col-xxl-6">
            ...
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1">مدیرت شهر  ها</h4>

                </div><!-- end card header -->

                <div class="card-body">
                    <p class="text-muted">
                        در این قسمت میتوانید شهر  هایی که با مجموعه قرار دارند اضافه یا حذف نمود
                    </p>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" wire:model="name" name="name" class="form-control"
                                               placeholder="مثلا:مشهد" id="name">
                                        @error('name') <span class="text-danger text-sm">{{ $message }}</span> @enderror
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="stateId2" class="form-label">انتخاب استان مربوطه:</label>
                                        <sup style="color: red">*</sup>
                                        <select name="stateId" wire:model="stateId" class="form-select mb-3" wire:ignore>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title mb-0">لیست شهر  های تحت مجموعه </h5>
                    </div>
                    <div class="card-body">
                        <div id="alternative-pagination_wrapper" class="dataTables_wrapper dt-bootstrap5 no-footer">
                                    ...
                                    <div class="d-flex justify-content-sm-end">
                                        <div class="search-box ms-2">
                                            <input wire:model.live.debounce.500ms="search" type="text"
                                                   class="form-control search" placeholder="جستجو بر اساس نام شهر ">
                            ...
                            <div class="row">
                                <div class="table-responsive table-card mb-4">
                                    <table id="alternative-pagination"
                                        ...
                                        <tr>
                                            ...
                                            <th  tabindex="0" aria-controls="alternative-pagination"
                                                 ...
                                                 aria-label=" نام شهر: activate to sort column ascending">نام شهر
                                            </th>
                                            <th  tabindex="0" aria-controls="alternative-pagination"
                                                 rowspan="1" colspan="1" style="width: 183.661px;"
                                                 aria-label="استان مربوطه: activate to sort column ascending">استان مربوطه
                                            </th>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center fw-medium">
                                                        <a href="javascript:void(0);"
                                                           class="currency_name">{{ $city->name }}</a>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="d-flex align-items-center fw-medium">
                                                        <a href="javascript:void(0);"
                                                           class="currency_name">{{ $city->state->name }}</a>
                                                    </div>
                                                </td>
                                    ...
                                    {{$cities->links('layouts.manager.pagination')}}
