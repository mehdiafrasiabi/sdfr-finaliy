        ...
        <div class="col-xxl-6">
            ...
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1">مدیریت درگاه های پرداخت ویسایت </h4>

                </div><!-- end card header -->

                <div class="card-body">
                    <p class="text-muted">
                        لطفا مرچنت دریافتی را از درگاه مورد نظر دریافت کنید و برای راه اندازی به پشتیبان فنی اطلاع دهید
                    </p>
                    <div class="live-preview">
                        <form wire:submit="submit(Object.fromEntries(new FormData($event.target)))">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="name" class="form-label">نام درگاه دریافتی:</label>
                                        <input type="text" wire:model="name" name="name" class="form-control"
                                               placeholder="مثلا:زیبال" id="name">
                                        @error('name') <span class="text-danger text-sm">{{ $message }}</span> @enderror
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="merchantCode" class="form-label">مرجنت کد دریافتی از درگاه:</label>
                                        <input type="text" wire:model="merchantCode" name="merchantCode" class="form-control"
                                                id="merchantCode">
                                        @error('merchantCode') <span class="text-danger text-sm">{{ $message }}</span> @enderror
                                    </div>
                                </div>
                                <!--end col-->
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title mb-0">لیست درگاه های پرداخت</h5>
                    </div>
                    <div class="card-body">
                                    ...
                                    <div class="d-flex justify-content-sm-end">
                                        <div class="search-box ms-2">
                                            <input wire:model.live.debounce.500ms="search" type="text"
                                                   class="form-control search" placeholder="جستجو بر اساس نام درگاه">
                                    ...
                                    <table id="alternative-pagination"
                                        ...
                                        <tr>
                                            ...
                                            <th  tabindex="0" aria-controls="alternative-pagination"
                                                 ...
                                                 aria-label="نام درگاه دریافتی: activate to sort column ascending">نام درگاه دریافتی
                                            </th>
                                            <th  tabindex="0" aria-controls="alternative-pagination"
                                                 rowspan="1" colspan="1" style="width: 183.661px;"
                                                 aria-label="کد دریافتی از درگاه: activate to sort column ascending">کد دریافتی از درگاه
                                            </th>
                                        ...
                                        @forelse($paymentMethod as $payment)
                                            <tr class="odd">
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center fw-medium">
                                                        <a href="javascript:void(0);"
                                                           class="currency_name">{{ $payment->name }}</a>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="d-flex align-items-center fw-medium">
                                                        <a href="javascript:void(0);"
                                                           class="currency_name">{{ $payment->merchant_id }}</a>
                                                    </div>
                                                </td>

                                                <td>
                                                    <label>فعال سازی درگاه:</label>
                                                    <input

                                                        wire:confirm="آیا مطمئن هستید؟ با انتخاب شما به عنوان درگاه اصلی قرار خواهد گرفت و توجه کنید که دیگر درگاه های موجود را غیرفعال خواهند شد و سپس این درگاه را فعال میشود !"
                                                        wire:change="changeStatus({{$payment->id}})"
                                                        {{$payment->active?'checked': ''}}   class="form-check-input" style="margin-left: 10px"
