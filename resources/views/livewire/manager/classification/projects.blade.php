                        ...
                        <form wire:submit="submit">
                            ...
                            <div class="mb-3">
                                        ...
                                        <div class="d-flex align-items-center gap-2 mb-1">
                                            ...
                                            <div class="form-check form-check-inline ms-auto">
                                                ...
                                                <label class="form-check-label small"
                                                       for="gs12_gen_{{ $index }}">عمومی</label>
                                ...
                                <div class="card card-body bg-light mb-2">
                                    ...
                                    <h6 class="mb-2"><i class="ri-graduation-cap-line me-1"></i>دانش‌آموزان پایه یازدهم:
                                    </h6>
                                    ...
                                    @foreach($gradeSettings[11] as $index => $setting)
                                        ...
                                        <div class="d-flex align-items-center gap-2 mb-1">
                                            ...
                                            <div class="form-check form-check-inline ms-auto">
                                                ...
                                                <label class="form-check-label small"
                                                       for="gs11_gen_{{ $index }}">عمومی</label>
                                ...
                                <div class="card card-body bg-light">
                                    ...
                                    <h6 class="mb-2"><i class="ri-graduation-cap-line me-1"></i>دانش‌آموزان پایه دهم:
                                    </h6>
