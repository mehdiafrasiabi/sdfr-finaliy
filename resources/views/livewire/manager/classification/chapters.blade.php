                ...
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    ...
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('manager.classification.grades', $subject->grade->education_level_id) }}">{{ $subject->grade->educationLevel->name }}</a></li>
                            <li class="breadcrumb-item"><a href="{{ route('manager.classification.subjects', ['educationLevel' => $subject->grade->education_level_id, 'grade' => $subject->grade->id]) }}">{{ $subject->grade->name }}</a></li>
                    ...
                    <div class="card-body py-2">
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <div>
                                ...
                                <span class="badge bg-{{ $subject->type === 'general' ? 'info' : 'warning' }}-subtle text-{{ $subject->type === 'general' ? 'info' : 'warning' }} ms-2">
                                {{ $subject->type_name }}
                            </span>
                            </div>
                        </div>
