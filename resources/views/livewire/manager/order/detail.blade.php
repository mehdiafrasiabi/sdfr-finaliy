    ...
    <div class="row">
                                ...
                                <td>
                                    <div class="d-flex">
                                        <div class="flex-shrink-0 avatar-md bg-light rounded p-1">
                                            <img src="/products/{{$item->product->id}}/photo/{{@$item->product->coverImage->path}}" alt="" class="img-fluid d-block">
                                        </div>
                                            <h5 class="fs-15"><a href="#" class="link-primary">{{$item->product->name}}</a></h5>
        ...
        <div class="col-xl-3">
            <div class="card">
                <div class="card-header">
                    <div class="d-flex">
                        <h5 class="card-title flex-grow-1 mb-0"><i class="mdi mdi-truck-fast-outline align-middle me-1 text-muted"></i>وضعیت</h5>
                        <div class="flex-shrink-0">
                            <a href="javascript:void(0);" class="badge bg-{{$orderDetails->statusPaymentColor}}-subtle text-{{$orderDetails->statusPaymentColor}} fs-11">
                ...
                <div class="card-body">
                    <div class="text-center">
                            ...
                            <div >
                                ...
                                @else
                                    <svg xmlns="http://www.w3.org/2000/svg" width="204.114" height="157.017" viewBox="0 0 204.114 157.017">
                                        <defs>
                                            <style>
                                                .cls-2{fill:#4db757}
                                            </style>
                ...
                <div class="card-body">
                    <ul class="list-unstyled mb-0 vstack gap-3">
                        <li>
                            <div class="d-flex align-items-center">
                                <div class="flex-shrink-0">
                                    <img src="{{$orderDetails->user->picture??'/manager/assets/images/users/avatar-3.jpg'}}" alt="" class="avatar-sm rounded">
                                </div>
                        ...
                        <li><i class="ri-mail-line me-2 align-middle text-muted fs-16"></i>{{$orderDetails->user->emial ?? 'وجود ندارد'}}</li>
                        <li><i class="ri-phone-line me-2 align-middle text-muted fs-16"></i>{{$orderDetails->user->mobile}}</li>
                    </ul>
                </div>
            </div>
            <!--end card-->
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title mb-0"><i class="ri-map-pin-line align-middle me-1 text-muted"></i>اطلاعات دانش اموز</h5>
                </div>
                <div class="card-body">
            ...
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title mb-0"><i class="ri-secure-payment-line align-bottom me-1 text-muted"></i>جزئیات پرداخت</h5>
                </div>
                <div class="card-body">
                    <div class="d-flex align-items-center mb-2">
                        <div class="flex-shrink-0">
