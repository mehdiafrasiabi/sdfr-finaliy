    ...
    <div class="row">
        ...
        <div class="col-12">
            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                ...
                <h4 class="mb-sm-0">افزودن استوری</h4>
                ...
                <div class="page-title-right">
                    ...
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">افزودن استوری</li>
        ...
        <div class="col-lg-7">
            ...
            <div class="card">
                ...
                <div class="card-header">
                    ...
                    <h5 class="card-title mb-0">اطلاعات استوری</h5>
                    ...
                    <form wire:submit="submit">
                        ...
                        <div class="mb-3">
                            ...
                            <label class="form-label">
                                ...
                                تصویر کاور <span class="text-danger">*</span>
                            ...
                            <div x-data="{ isUploading: false, progress: 0 }"
                                ...
                                <button type="button" class="btn btn-outline-primary"
                                    ...
                                    <i class="ri-upload-2-line me-1"></i> انتخاب
                            ...
                            <div class="alert alert-light mt-2 mb-0 small">
                                ...
                                تصویر خود را جهت بارگذاری انتخاب کنید<br>

                                <span class="text-muted">(فرمت های مجاز: JPG, PNG, WEBP, GIF, SVG)</span><br>

                                <span class="text-muted">(حجم مجاز فایل تا 50 مگابایت میباشد.)</span>
                        ...
                        @if($type === 'video')
                            ...
                            <div class="mb-3">
                                ...
                                <input type="url" class="form-control @error('storyVideoUrl') is-invalid @enderror"
                                       ...
                                       placeholder="http://127.0.0.1:8000/stories/story/sSD2gPeZOanQQPW8K8pIhQpQmal258ki3St1dXlb.mp4">
                        ...
                        @else
                            ...
                            <div class="mb-3">
                                ...
                                <label class="form-label">تصویر استوری <span class="text-danger">*</span></label>
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="url" class="form-control" id="widgetLink"
                                               ...
                                               wire:model.live="widgetLink"
                                               placeholder="http://127.0.0.1:8000/stories/story/...">
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <button type="submit" class="btn btn-success">
                                ...
                                <span wire:loading.remove wire:target="submit">
                                    ...
                                    <i class="ri-check-line me-1"></i> ذخیره استوری
                        ...
                        <div class="story-preview"
                            ...
                            <div style="position: absolute; bottom: 80px; left: 15px;">
                                ...
                                <div style="display: flex; flex-direction: column; align-items: center;">
                                    ...
                                    <span class="text-white" style="font-size: 10px;">۸</span>
