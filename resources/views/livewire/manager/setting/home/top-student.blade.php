        ...
        <div class="col-xxl-6">
            ...
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-name mb-0 flex-grow-1">مدیرت دانش اموزان sdfr</h4>
                        ...
                        <form wire:submit="submit(Object.fromEntries(new FormData($event.target)))">
                            <div class="row">
                                ...
                                <div class="field-wrapper  mb-4" x-data="{isUploading:false,progress:0 }"
                                    ...
                                    <label for="document" class="form-label">تصویر دانش آموز :</label>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-name mb-0">لیست دانش اموز </h5>
                    </div>
                    <div class="card-body">
                                    ...
                                    <table id="alternative-pagination"
                                        ...
                                        @forelse($sdfrStudents as $sdfr)
                                            <tr class="odd">
                                                ...
                                                <td>
                                                    <button wire:click="showMedia('image', '/client/sdfr/topStudent/{{$sdfr->document}}')" class="btn btn-secondary">
                                                        نمایش عکس
                                                    </button>
                                                </td>
