        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title mb-0">لیست کل دانش اموزان</h4>
                </div>
                <!-- end card header -->
                            ...
                            <div class="col-sm">
                                ...
                                <form wire:submit.prevent="export" class="me-2">
                                    <button type="submit" class="btn btn-success btn-sm">
                                        <i class="ri-download-2-fill align-middle me-1"></i> خروجی اکسل
                                    </button>
                                </form>
                            </div>
                        ...
                        <div class="table-responsive table-card mt-3 mb-1">
                            <table class="table align-middle table-nowrap" id="customerTable">
                                ...
                                <tr>
                                    ...
                                    <th class="sort" data-sort="phone">موبایل</th>
                                    <th class="sort" data-sort="phone"> پدر</th>
                                    <th class="sort" data-sort="phone">مادر</th>
                                ...
                                @forelse($students as $student)
                                    <tr wire:key="student-{{ $student->id }}">
                                        ...
                                        <td class="customer_name">{{ $student->user->personalInformation->name ?? '---' }}</td>
                                        <td class="phone">{{ $student->user->personalInformation->code_mell ?? '---' }}</td>
                                        <td class="phone">{{ $student->user->mobile ?? '---' }}</td>
