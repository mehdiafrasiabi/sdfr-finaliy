{{--
    محتوای مشترک کارنامهٔ هوشمند.
    این پارشال بین صفحهٔ دانش‌آموز و پنل مشاور به اشتراک گذاشته می‌شود تا
    دقیقاً همان دیتا و همان نمایش در هر دو سمت رندر شود.

    متغیرهای مورد انتظار:
      $card, $current, $previous, $currentSessions, $previousSessions,
      $subjectsByGrade, $availableGrades, $analysis, $currentLabel, $previousLabel
    متغیرهای اختیاری:
      $columnClass (کلاس wrapper ستون)، $backUrl (لینک دکمهٔ بازگشت)
--}}
@php
    $columnClass = $columnClass ?? 'space-y-8';
    $backUrl = $backUrl ?? route('client.profile.reportStudentStudy');
