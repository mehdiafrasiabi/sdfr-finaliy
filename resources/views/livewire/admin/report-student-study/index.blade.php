<div>
            ...
            <div class="trezo-card bg-white dark:bg-[#0c1427] p-[20px] md:p-[25px] rounded-md">
                <div class="trezo-card-header mb-[20px] md:mb-[25px] flex items-center justify-between">
                    <div class="trezo-card-title">
                        <h5 class="!mb-0">ارسال مستندات گزارش درسی دانش اموزان برای مدیران</h5>
                    </div>
                </div>
                    ...
                    <div class=" overflow-x-auto">
                        <form wire:submit="sendFile(Object.fromEntries(new FormData($event.target)))">
                            ...
                            <div class="mb-[20px] md:mb-[25px] last:mb-0">
                                ...
                                @error('body')
                                <div message="text-[12px] font-medium text-orange-500  "
    ...
    <div class="lg:col-span-2">
        ...
        <div class="trezo-card bg-white dark:bg-[#0c1427] p-[20px] md:p-[25px] rounded-md">
            <div class="trezo-card-header mb-[20px] md:mb-[25px] flex items-center justify-between">
                <div class="trezo-card-title">
                    <h5 class="!mb-0">گزارش مستندات برای مدیر</h5>
                </div>
                    ...
                    <table class="w-full">
                        ...
                        @forelse($myFiles as $file)
                            <tr>
                                ...
                                <td class="ltr:text-left rtl:text-right whitespace-nowrap px-[20px] py-[15px] md:ltr:first:pl-[25px] md:rtl:first:pr-[25px] ltr:first:pr-0 rtl:first:pl-0 border-b border-gray-100 dark:border-[#172036]">
                                    <div class="flex items-center">
                                        <div class="ltr:ml-[12px] rtl:mr-[12px]">
                                            <span class="block font-medium">{{ $file->receiver->name ?? '----'}}</span>
                                        </div>
                                    </div>
                                </td>
                                <td class="ltr:text-left rtl:text-right whitespace-nowrap px-[20px] py-[15px] md:ltr:first:pl-[25px] md:rtl:first:pr-[25px] ltr:first:pr-0 rtl:first:pl-0 border-b border-gray-100 dark:border-[#172036]">
                                ...
                                <td class="ltr:text-left rtl:text-right whitespace-nowrap px-[20px] py-[15px] md:ltr:first:pl-[25px] md:rtl:first:pr-[25px] ltr:first:pr-0 rtl:first:pl-0 border-b border-gray-100 dark:border-[#172036]">
                                    {{jalali($file ->created_at)->format('%d %B %Y')}}
                                </td>

                                <td class="ltr:text-left rtl:text-right whitespace-nowrap px-[20px] py-[15px] md:ltr:first:pl-[25px] md:rtl:first:pr-[25px] ltr:first:pr-0 rtl:first:pl-0 border-b border-gray-100 dark:border-[#172036]">
                                    <div class="flex items-center gap-[9px]">
                                        <a href="#" class="text-gray-500 dark:text-gray-400 leading-none">
