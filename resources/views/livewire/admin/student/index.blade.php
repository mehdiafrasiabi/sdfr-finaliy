<div class="student-ui student-ui-auto-collapse">
    ...
    @push('link')
        <style>
            ...
            .student-avatar-shell.student-avatar-male {
                background: #dbeafe;
            }

            .student-avatar-shell.student-avatar-female {
                background: #fce7f3;
            }

            .student-avatar-shell.student-avatar-neutral {
                background: #e5e7eb;
            }
        </style>
    @endpush
            ...
            <div class="card overflow-hidden">
                ...
                <div class="card-body p-0 pb-2">
                    <div id="dt_basic_wrapper" class="dt-container dt-bootstrap5 dt-empty-footer">
                        ...
                        <!-- Top Controls -->
                        <div class="row mt-2 justify-content-between mx-2 py-2 g-2">
                            <div class="col-12 col-lg">
                                <div class="row g-2">
                                    <div class="col-12 col-md-4">
                                        <select class="form-select form-select-sm" wire:model.live="fieldFilter">
                                            <option value="">فیلتر رشته</option>
                                    ...
                                    <div class="col-12 col-md-4">
                                        <select class="form-select form-select-sm"
                                            ...
                                            <option value="">فیلتر پایه</option>
                            ...
                            <div class="col-12">
                                @if($fieldFilter === '')
                                    <small class="text-muted">برای انتخاب پایه، اول رشته را مشخص کن.</small>
                                @elseif($fieldFilter === 'none')
                                    <small class="text-muted">حالت بدون رشته مخصوص دانش‌آموزان پایه نهم است.</small>
                                @endif
                            </div>
                            ...
                            <div
                                ...
                                <table class="table display" style="width: 100%;">
                                    ...
                                    <tr>
                                        ...
                                        <th data-dt-column="1">پایه و رشته</th>
                                    ...
                                    @forelse($students as $student)
                                        @php
                                            ...
                                            $avatarUrl = $this->resolveUserPictureUrl($user);
                                            $avatarClass = match($profile?->gender) {
                                                'male' => 'student-avatar-male',
                                                'female' => 'student-avatar-female',
                                                default => 'student-avatar-neutral',
                                            };
                                        @endphp
                                        <tr>
                                            <td>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-left align-items-center">
                                                    <div class="avatar-wrapper">
                                                        <div class="student-avatar-shell {{ $avatarClass }} me-2">
                                                            @if($avatarUrl)
                                                                <img
                                                                    src="{{ $avatarUrl }}"
                                                            ...
                                                            @else
                                                                <span class="avatar-title text-secondary fs-4">
                                            ...
                                            <td>
                                                @if(($personalInfo->grade ?? null) == 12)
                                                    دوازدهم
                                                @elseif(($personalInfo->grade ?? null) == 11)
                                                    یازدهم
                                                @elseif(($personalInfo->grade ?? null) == 10)
                                                    دهم
                                                @elseif(($personalInfo->grade ?? null) == 9)
                                                    نهم
                                                @endif

                                                @if(($personalInfo->field ?? null) == 'math')
                                                    ریاضی
                                                @elseif(($personalInfo->field ?? null) == 'experimental')
                                                    تجربی
                                                @elseif(($personalInfo->field ?? null) == 'human')
                                                    انسانی
                                                @elseif(($personalInfo->grade ?? null) == 9)
                                                    بدون رشته
                                                @endif
                                            ...
                                            <td>
                                                {{$personalInfo->father_mobile ?? '-'}}
                                            </td>

                                            <td>
                                                {{$personalInfo->mother_mobile ?? '-'}}
                                            </td>
                                            <td>
                                                {{$personalInfo->birth_date}}
                                            </td>
                                            <td>
                                                {{ $personalInfo->state->name ?? '-' }}
                                            </td>

                                            <td>
                                                {{ $personalInfo->city->name ?? '-' }}
                                            </td>
                                        </tr>
                                    @empty
                                        <tr>
