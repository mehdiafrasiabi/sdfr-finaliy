<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <h4 class="py-3 mb-4">
        <span class="text-muted fw-light">گزارش /</span>
        گزارش جامع
    </h4>
            ...
            <table class="table">
                ...
                @forelse($students as $student)
                    <tr>
                        ...
                        <td>
                            <a href="{{route('admin.student.reportDailyActivities.detail',$student->payment->order->user->id)}}" class="btn btn-sm btn-icon item-edit waves-effect waves-light">
                                <i
