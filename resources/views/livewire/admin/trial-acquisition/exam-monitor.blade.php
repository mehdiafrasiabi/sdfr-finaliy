<div class="trial-monitor-page" dir="rtl">
    @push('link')
        <style>
            ...
            .trial-monitor-hero-main{display:flex;align-items:center;gap:13px;min-width:0}.trial-monitor-hero-icon{display:inline-flex;align-items:center;justify-content:center;width:48px;height:48px;flex:0 0 48px;color:#fff;background:linear-gradient(135deg,#f59e0b,#f97316);border-radius:10px;font-size:1.2rem}
    ...
    <div class="app-page-head">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ route('admin.trial-acquisition.monitor') }}">رصد دانش‌آموزان یک هفته آزمایشی</a></li>
                <li class="breadcrumb-item active">رصد دانش‌آموزان بازه امتحانات</li>
            </ol>
        </nav>
    </div>
    ...
    <section class="trial-monitor-hero">
        <div class="trial-monitor-hero-main">
            <span class="trial-monitor-hero-icon"><i class="fi fi-rr-calendar-clock"></i></span>
            <div>
                <h3>رصد دانش‌آموزان برنامه امتحانی</h3>
                <p>بررسی بازه امتحانات، برنامه مطالعاتی، گزارش عملکرد و وضعیت پیشرفت دانش‌آموزان.</p>
            </div>
        </div>
        ...
        <div class="col-xl-3">
            <div class="card border-0 shadow-sm h-100 trial-students-card">
                <div class="card-header bg-white">
                    <div class="fw-bold">دانش‌آموزان بازه امتحانات</div>
                        ...
                        <button type="button" wire:click="selectTrial({{ $trial->id }})" class="list-group-item list-group-item-action {{ $active ? 'active' : '' }}">
                            ...
                            @if($examStage)
                                <div class="small mt-1">
                                    <span class="badge bg-{{ $examStage['color'] }}">{{ $examStage['label'] }}</span>
                                </div>
                            @endif
            ...
            @if($selectedTrial)
                ...
                @else
                    ...
                    <div class="card border-0 shadow-sm mb-3">
                        <div class="card-body d-flex flex-wrap gap-2 trial-exam-summary">
                    ...
                    <div class="row g-3 mb-3 trial-stats-row">
                        ...
                        <div class="col-6 col-lg-3">
                            <div class="card border-0 shadow-sm h-100 trial-stat-card"><div class="card-body">
                                ...
                                <h3 class="mb-0 text-success">{{ number_format($monitorSummary['sent_reports_until_now']) }}</h3>
                            </div></div>
                        </div>
                        <div class="col-6 col-lg-3">
                            <div class="card border-0 shadow-sm h-100 trial-stat-card"><div class="card-body">
                                <div class="text-muted small">عدم گزارش تا الان</div>
                                <h3 class="mb-0 text-danger">{{ number_format($monitorSummary['missing_reports_until_now']) }}</h3>
                            </div></div>
                        </div>
                    </div>
                    ...
                    <div class="card border-0 shadow-sm mb-3 trial-section-card" x-data="{ open: true }">
                        <div class="card-header bg-white d-flex justify-content-between align-items-center gap-2 trial-section-header">
                            <div>
                                <strong>برنامه بازه امتحانات</strong>
                                @if($weeklyProgram)
                                    <div class="small text-muted">شروع {{ jalali($weeklyProgram->start_date)->format('%Y/%m/%d') }} تا {{ $weeklyProgram->end_date ? jalali($weeklyProgram->end_date)->format('%Y/%m/%d') : '—' }}</div>
                            @endif
                        </div>
                        ...
                        <div class="card-body" x-show="open" x-transition>
                                    ...
                                    @foreach($weekDays as $day)
                                        <div class="col-lg-6">
                                            <div class="border rounded-3 h-100 trial-day-card">
                                                <div class="p-3 border-bottom d-flex justify-content-between gap-2 trial-day-head">
                                                    <div>
                                                        <strong>{{ $day['name'] }}</strong>
                                                        <span class="text-muted small">{{ $day['jalali_date'] }}</span>
                                                    </div>
                                                    <div class="d-flex flex-wrap gap-1 trial-day-badges">
                                                        @if($day['is_rest_day'])<span class="badge bg-success">استراحت</span>@endif
                                                        @if($day['is_exam_day'])<span class="badge bg-warning text-dark">امتحان</span>@endif
                                                ...
                                                <div class="p-3">
                                                    @if($day['can_view_details'])
                                                        <div class="mb-2">
                                                            @if($day['report_id'])
                                                                <button type="button" wire:click="openDetailModal({{ $day['report_id'] }})" class="btn btn-sm btn-outline-primary">مشاهده جزئیات</button>
                                                            @else
                                                                <button type="button" wire:click="openDayDetailModal({{ $day['index'] }})" class="btn btn-sm btn-outline-danger">مشاهده جزئیات</button>
                                                            @endif
                                                        </div>
                                                    @endif
                            ...
                            @else
                                <div class="text-center text-muted py-4">هنوز برنامه امتحانی برای این دانش‌آموز ساخته نشده است.</div>
                            @endif
                        </div>
                    </div>
                        ...
                        <div class="card border-0 shadow-sm mb-3 trial-section-card" x-data="{ open: true }">
                            <div class="card-header bg-white d-flex justify-content-between align-items-center gap-2 trial-section-header">
                                <div>
                                    ...
                                    <div class="small text-muted">فعالیت‌های مطالعاتی ثبت‌شده خارج از پارت‌های برنامه امتحانی</div>
                                </div>
                    ...
                    <div class="card border-0 shadow-sm mb-3 trial-section-card" x-data="{ open: true }">
                        <div class="card-header bg-white">
                            <div class="d-flex flex-wrap justify-content-between align-items-center gap-3 trial-report-head">
                                <div>
                                    <strong>لیست گزارش‌های مورد انتظار بازه امتحانات</strong>
                                    <div class="small text-muted">
                                ...
                                <div class="d-flex align-items-center flex-wrap gap-2 trial-report-controls">
                                    <select wire:model.live="reportStatus" class="form-select form-select-sm w-auto">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover align-middle mb-0 trial-report-table">
                                        ...
                                        @foreach($expectedReportRows as $row)
                                            ...
                                            @endphp
                                            <tr wire:key="trial-exam-expected-report-{{ $row['student_id'] }}-{{ $row['report_date'] }}">
    ...
    @if($commentModalOpen)
        <div class="modal fade show d-block trial-modal-layer" tabindex="-1" wire:click.self="closeCommentModal">
    ...
    @if($detailModalOpen)
        <div class="modal fade show d-block trial-modal-layer" tabindex="-1" wire:click.self="closeDetailModal">
                            ...
                            <table class="table table-sm table-bordered align-middle trial-detail-table">
                                <thead class="table-light">
                                    <tr>
                                        <th>درس</th>
                                        <th>فصل/مبحث</th>
                                        <th class="text-center">انجام پارت</th>
                                        <th class="text-center">نوع</th>
                                        <th class="text-center">زمان</th>
                                        <th class="text-center">مطالعه</th>
                                        <th class="text-center">تست</th>
                                        <th class="text-center">امتیاز</th>
                                    </tr>
                                </thead>
    ...
    @if($dayDetailModalOpen)
        <div class="modal fade show d-block trial-modal-layer" tabindex="-1" wire:click.self="closeDayDetailModal">
            <div class="modal-dialog modal-xl modal-dialog-scrollable trial-modal-dialog trial-detail-dialog">
                <div class="modal-content border-0 shadow">
                    <div class="modal-header">
                            ...
                            <table class="table table-sm table-bordered align-middle trial-detail-table">
                                <thead class="table-light">
                                    <tr>
                                        ...
                                        <th class="text-center">انجام پارت</th>
                                        <th class="text-center">نوع</th>
                                        <th class="text-center">زمان برنامه</th>
                                        <th class="text-center">مطالعه ثبت‌شده</th>
                                        <th class="text-center">تست</th>
                                    </tr>
                                </thead>
                                <tbody>
