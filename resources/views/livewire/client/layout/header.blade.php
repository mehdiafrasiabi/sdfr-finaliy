                        ...
                        <div class="relative group/categories">
                            ...
                            <div
                                ...
                                <ul
                                    ...
                                    <li class="group">
                                        <a wire:navigate href="{{route('client.blog')}}"
                                    ...
                                    <li class="group">
                                        <a wire:navigate href="{{route('client.blog.ExamQuestion')}}"
                                           class="flex items-center relative text-foreground transition-colors hover:text-primary p-3">
                                    ...
                                    <li class="group">
                                        <a wire:navigate href="{{route('client.course')}}"
                                           class="flex items-center relative text-foreground transition-colors hover:text-primary p-3">
                        ...
                        <div class="relative group/categories">
                            ...
                            <div
                                ...
                                <ul
                                    class="flex flex-col relative w-56 min-h-[100px] bg-background border border-border shadow-2xl shadow-black/5">
                                    <li class="group">
                                        <a wire:navigate href="{{route('client.about-us')}}"
                                           class="flex items-center relative text-foreground transition-colors hover:text-primary p-3">
                                    ...
                                    <li class="group">
                                        <a wire:navigate href="{{route('client.contact-us')}}"
                                           class="flex items-center relative text-foreground transition-colors hover:text-primary p-3">
                                            <span class="font-semibold text-sm">ارتباط با ما</span>

                                        </a>
                                    </li>
                                    <li wire:navigate class="group">
            ...
            <div
                ...
                <div class="space-y-5 p-4">
                    ...
                    <ul class="flex flex-col space-y-1">
                        <li>
                            <a wire:navigate href="{{route('client.home')}}" wire:navigate
                        ...
                        <li>
                            <a wire:navigate href="{{route('client.shop')}}" wire:navigate
                               class="w-full flex items-center gap-x-2 relative text-muted transition-all hover:text-foreground py-2">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                                     class="w-6 h-6">
                                    <path fill-rule="evenodd"
                        ...
                        <li>
                            <a wire:navigate href="{{route('client.blog')}}" wire:navigate
                               class="w-full flex items-center gap-x-2 relative text-muted transition-all hover:text-foreground py-2">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                                     class="w-6 h-6">
                                    <path fill-rule="evenodd"
                        ...
                        <li>
                            <a wire:navigate href="{{route('client.blog.ExamQuestion')}}" wire:navigate
                               class="w-full flex items-center gap-x-2 relative text-muted transition-all hover:text-foreground py-2">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                                     class="w-6 h-6">
                                    <path fill-rule="evenodd"
...
{{-- دوره های آموزشی--}}
                        ...
                        @else
                            <li>
                                <a wire:navigate href="{{route('client.course')}}" wire:navigate
                                   class="w-full flex items-center gap-x-2 relative text-muted transition-all hover:text-foreground py-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                                         class="w-6 h-6">
                                        <path fill-rule="evenodd"
