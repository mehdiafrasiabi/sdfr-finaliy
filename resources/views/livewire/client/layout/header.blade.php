<div x-data="{ offcanvasOpen: false }"
     ...
     x-init="$watch('offcanvasOpen', value => {

         if (value) {

             document.body.style.overflow = 'hidden';

      window.dispatchEvent(new CustomEvent('header-opened'));

         } else {

             document.body.style.overflow = '';

             window.dispatchEvent(new CustomEvent('header-closed'));
                            ...
                            <div
                                ...
                                <a href="{{route('client.logout')}}"
                                   class="flex items-center gap-2 w-full text-red-500 transition-colors hover:text-red-700 px-3 py-2">
                                    ...
                                    <div class="font-semibold text-xs">خروج از
                                        حساب
                                    </div>
                                </a>
                            </div>
