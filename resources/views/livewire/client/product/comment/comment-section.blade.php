<div>
    <div class="space-y-5">
        ...
        @if(session()->has('success'))
            ...
            <div
                class="bg-green-100 dark:bg-green-900/30 border border-green-400 dark:border-green-600 text-green-700 dark:text-green-400 px-4 py-3 rounded-xl relative mb-4"
                role="alert">
        ...
        <div class="bg-background border border-border rounded-3xl p-5 mb-5">
            ...
            @auth
                <div class="flex items-center gap-3 mb-5">
                    ...
                    <div
                        class="flex-shrink-0 w-10 h-10 rounded-full overflow-hidden bg-secondary flex items-center justify-center">
        ...
        <div class="space-y-3">
            ...
            @forelse($comments as $comment)
                ...
                <div class="space-y-3">
                    ...
                    <div
                        class="bg-background border border-border rounded-3xl
                            ...
                            <div class="flex items-center gap-3">
                                ...
                                <div
                                    ...
                                    @else
                                        ...
                                        <span
                                            class="text-foreground font-bold">{{ mb_substr($comment->user->name, 0, 1) }}</span>
                                ...
                                <div class="flex flex-col items-start space-y-1">
                                    ...
                                    <span
                                        class="line-clamp-1 font-semibold text-sm text-foreground">{{ $comment->user->name }}</span>

                                    <span
                                        class="text-xs text-muted">{{\Morilog\Jalali\Jalalian::fromDateTime($comment->created_at)->ago() }}</span>
