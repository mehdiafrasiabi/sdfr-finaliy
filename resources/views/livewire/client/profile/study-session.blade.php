                                ...
                                <div class="rounded-2xl p-4 text-white" style="background:#1a0a2e; border:1px solid #5b21b6;">
                                    ...
                                    <div class="w-full rounded-full mb-3" style="height:3px; background:#2d1b69;">
                                        <div id="makeup-progress" class="h-full rounded-full"
                                             style="width:{{ $makeupTargetSeconds > 0 ? ($makeupLiveSeconds/$makeupTargetSeconds*100) : 0 }}%; background:#a78bfa; transition:width .3s;"></div>
                                    </div>
                                    ...
                                    <div class="rounded-2xl p-4 text-white" style="background:#1a0a2e; border:1px solid #5b21b6;" >
                                        ...
                                        <div class="w-full rounded-full mb-3" style="height:3px; background:#2d1b69;">
                                            <div id="extra-progress" class="h-full rounded-full"
                                                 style="width:{{ $extraTargetSeconds > 0 ? ($extraLiveSeconds/$extraTargetSeconds*100) : 0 }}%; background:linear-gradient(to left,#a78bfa,#7c3aed); transition:width .3s;"></div>
                                        </div>
                                        <div class="flex gap-2 justify-end">
                                            @if($isRunning)
