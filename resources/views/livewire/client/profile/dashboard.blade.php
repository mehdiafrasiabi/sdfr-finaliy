<div class="min-h-screen text-white" dir="rtl" style="font-family: inherit;" x-data="{ openAdvisorModal: false }">
    ...
    <div class="cosmic-bg" wire:ignore aria-hidden="true">
        ...
        <svg class="spaceship" viewBox="0 0 80 120" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
            ...
            {{-- بدنه --}}
            <path d="M40 6 C54 20 58 44 54 70 L52 84 H28 L26 70 C22 44 26 20 40 6 Z" fill="url(#shipBody)" stroke="#cbd5e1" stroke-width="1"/>
            {{-- بال‌ها --}}
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div class="glass rise md:col-span-2 p-4 flex items-center justify-between gap-4" data-tour="advisor" style="animation-delay:.1s;margin-bottom: 36px">
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            @else
                                <div class="w-12 h-12 rounded-full bg-white/5 ring-2 ring-white/15 flex items-center justify-center flex-shrink-0">
                    ...
                    <div class="glass rise p-4" data-tour="report" style="animation-delay:.15s">
                        ...
                        <p class="text-[11px] text-neutral-400 mb-4">تعداد روزهایی که این هفته گزارش روزانه ثبت کرده‌ای</p>
                    ...
                    <div class="glass rise p-4" data-tour="study" style="animation-delay:.2s">
                        ...
                        <div class="w-full rounded-full h-[6px] bg-white/10 mb-3 overflow-hidden">
                            <div class="h-full rounded-full bg-gradient-to-l from-emerald-400 to-sky-500 transition-all duration-700"
                        ...
                        @if($studyHoursProgress['extra_hours'] > 0)
                            <div class="mt-3 text-xs font-semibold px-3 py-2 rounded-xl inline-flex items-center gap-1.5 bg-emerald-500/10 text-emerald-300 ring-1 ring-emerald-500/20">
                ...
                goTo(i) {
                        ...
                        card.scrollIntoView({ behavior: 'smooth', inline: 'start', block: 'nearest' });
                                ...
                                <div class="program-carousel -mx-4 px-4"
                                    ...
                                    @foreach($todayProgram as $part)
                                        ...
                                        @endphp
                                        <div class="program-card rounded-2xl bg-white/5 ring-1 ring-white/10 px-4 py-3 flex items-center justify-between gap-3 min-h-[72px]">
                            ...
                            <div class="hidden md:block relative">
                                <div class="absolute left-0 top-0 bottom-0 w-12 bg-gradient-to-l from-transparent to-[#0a0f1a]/70 z-10 pointer-events-none rounded-l-xl"></div>
                                <div class="program-scroll-desktop">
                                    @foreach($todayProgram as $part)
                                        @php
                                            ...
                                            $testsCount = $part->tests_count ?? $part->test_count ?? 0;
                                        @endphp
                                        <div class="flex-shrink-0 rounded-2xl bg-white/5 ring-1 ring-white/10 px-4 py-3 flex items-center justify-between gap-4"
                    ...
                    <div class="glass card-data rise p-4" data-tour="chart" style="animation-delay:.3s">
                        <div class="flex items-center justify-between gap-2 mb-1">
                            <div class="flex items-center gap-2">
                                <div class="icon-chip">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="#7dd3fc" class="w-4 h-4">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="M3 13.125C3 12.504 3.504 12 4.125 12h2.25c.621 0 1.125.504 1.125 1.125v6.75C7.5 20.496 6.996 21 6.375 21h-2.25A1.125 1.125 0 013 19.875v-6.75z"/>
                                    </svg>
                                </div>
                                <span class="font-bold text-white text-[15px]">مطالعه روزانه</span>
                                <span class="text-[10px] px-2 py-0.5 rounded-full bg-sky-500/10 text-sky-300 ring-1 ring-sky-500/20">تحلیل</span>
                            </div>
                        ...
                        <p class="text-[11px] text-neutral-400 mb-4">ساعت برنامه‌ریزی‌شده در برابر ساعت واقعی مطالعه در هر روز هفته</p>
                    ...
                    <div class="glass card-data rise md:col-span-1 p-4" style="animation-delay:.35s">
                        ...
                        <p class="text-[11px] text-neutral-400 mb-4">درصد پیشرفت تو در هر درس بر اساس پارت‌های انجام‌شده</p>
                                ...
                                @foreach($wi['subjects'] as $subj)
                                    ...
                                    <div>
                                        <div class="flex items-center justify-between mb-1.5">
                                            ...
                                            <span class="text-[11px] text-neutral-400 whitespace-nowrap">{{ $subj['parts_studied'] }}/{{ $subj['parts_total'] }} پارت · <span class="{{ $txtColor }} font-bold">{{ $pct }}%</span></span>
                                        </div>
                        ...
                        @else
                            <div class="text-center py-8 text-neutral-500 text-[13px]">درسی برای نمایش پیشرفت وجود ندارد.</div>
                        @endif
                    </div>
                </div>{{-- end grid --}}
            </div>{{-- end main --}}
