                    ...
                    <div class="grid md:grid-cols-2 grid-cols-1 gap-6">
                        ...
                        <div class="profile-card">
                            ...
                            @if($supporterStudent && $supporterStudent->picture)
                                <div class="profile-avatar" style="background: none; box-shadow: none;">
                                    <img src="{{ asset('adminsFile/' . $supporterStudent->id . '/' . $supporterStudent->picture) }}"
                                         alt="{{ $supporterStudent->name }}"
                                         style="width:64px;height:64px;border-radius:50%;object-fit:cover;box-shadow:0 8px 20px rgba(102,126,234,0.3);">
                                </div>
                            @else
