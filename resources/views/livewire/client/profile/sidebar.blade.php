<div class="hidden md:block"
    ...
    <ul class="flex flex-col space-y-3 bg-secondary rounded-2xl p-5">
        ...
        @if ($showMyReport)
            <li>
                <a wire:navigate href="{{ route('client.profile.myReport') }}"
                   class="w-full h-11 inline-flex items-center text-right gap-3 rounded-full {{ request()->routeIs('client.profile.myReport') ? 'bg-primary text-primary-foreground px-4' : ' bg-background text-muted transition-colors hover:bg-primary hover:text-primary-foreground px-4' }}">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                         stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                         class="w-5 h-5">
                    ...
                    <span class="font-semibold text-xs">کارنامه‌ی من</span>
                </a>
            </li>
        @endif
        <li>
