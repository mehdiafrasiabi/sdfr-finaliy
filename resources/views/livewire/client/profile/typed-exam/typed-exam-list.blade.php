                    ...
                    <div class="space-y-5">
                        ...
                        @if($assignments->isEmpty())
                            ...
                            <div class="flex flex-col items-center justify-center space-y-12 py-16">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" class="w-20 h-20 text-muted opacity-50"
                                ...
                                <div class="text-center space-y-3">
                                    ...
                                    <h2 class="font-bold text-xl text-foreground">آزمونی برای شما ثبت نشده است</h2>

                                    <p class="text-muted text-sm">به محض تخصیص آزمون، در اینجا نمایش داده می‌شود.</p>
