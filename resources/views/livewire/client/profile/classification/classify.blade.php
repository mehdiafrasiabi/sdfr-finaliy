        ...
        <section class="mb-6 rounded-2xl border-2 border-border bg-card/95 p-5 sm:p-6 card-soft-shadow">
            <div class="space-y-5">
                ...
                <div class="relative">
                    ...
                    @if($totalTopics > 0)
                        <div
                            class="absolute -top-1 right-0 left-0 flex justify-between text-[10px] text-muted font-medium">
                            <span>0%</span>
                            <span>50%</span>
                            <span>100%</span>
                        </div>
        ...
        @if(!$showMyTopics)
            ...
            <section class="space-y-5 md:space-y-6">
                                            ...
                                            >
                                                <div
                                                    ...
                                                    <div class="flex-1 min-w-0">
                                                        <span
                                                            class="text-sm sm:text-base font-semibold text-foreground leading-relaxed block">
                                                            {{ $topic['name'] }}
                                                        </span>
                                                    </div>
                                                    {{-- Rating Controls --}}
                                                    <div class="flex items-center gap-3 sm:gap-4 flex-shrink-0">
                                                        {{-- Labels --}}
                                                        <div
                                                            class="hidden lg:flex items-center gap-2 text-xs text-muted font-medium"
                                                            dir="ltr">
                                                            <span
                                                                class="px-2 py-1 rounded bg-red-500/10 text-red-500">D</span>
                                                            <span class="text-muted/50">→</span>
                                                            <span
                                                                class="px-2 py-1 rounded bg-green-500/10 text-green-500">A+</span>
                                                        </div>
                ...
                @empty
                    {{-- Empty State --}}
                    <div
                        class="mt-8 rounded-2xl border-2 border-dashed border-border bg-card/90 py-16 text-center card-soft-shadow">
                                                ...
                                                <div class="flex-1">
                                                    ...
                                                    <span class="mt-1 block text-xs text-muted">
                                                        ...
                                                        @if($classification->topic->parent)
                                                            <span
                                                                class="text-info"> → {{ $classification->topic->parent->name }}</span>
                                                        @endif
                                                    </span>
                                                </div>
                ...
                <div class="flex items-center justify-between gap-4">
                    ...
                    <div class="flex items-center gap-3">
                        <div class="flex h-10 w-10 items-center justify-center rounded-xl
                            ...
                            <svg
                                class="w-5 h-5 {{ $completedTopics >= $totalTopics && $totalTopics > 0 ? 'text-green-500' : ($completedTopics > 0 ? 'text-blue-500' : 'text-amber-500') }}"
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            >
                                ...
                                <span wire:loading wire:target="submitClassification"
                                    ...
                                    <svg
                                        class="loading-spinner h-4 w-4 border-2 border-white border-t-transparent rounded-full"></svg>
                                    در حال ثبت...
                                </span>
                            </button>
                        </div>
