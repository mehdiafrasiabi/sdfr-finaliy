<div
    x-data="{ showPreSessionModal: @entangle('showPreSessionModal') }"
    class="min-h-screen bg-slate-50 dark:bg-slate-950 py-6 sm:py-10"
    dir="rtl"
>
    @push('link')
        <style>
    ...
    <div class="container mx-auto px-3 sm:px-4 max-w-5xl">
        ...
        {{-- لیست جلسات --}}
        <section
            class="sessions-card-shadow mb-8 overflow-hidden rounded-2xl border border-slate-100/80
                    ...
                    <div class="grid gap-3 sm:gap-4">
                        @foreach($weeklyPrograms as $program)
                            <a
                                ...
                                class="group block rounded-xl border border-slate-200 bg-slate-50/60 px-4 py-3 text-xs sm:text-sm
                                       transition hover:border-blue-400 hover:bg-blue-50/60
                                       dark:border-slate-700 dark:bg-slate-900/80 dark:hover:border-blue-400 dark:hover:bg-slate-900"
                            >
                                <div class="flex items-center justify-between gap-4">
                                    <div>
                                        <div class="font-medium text-slate-900 dark:text-slate-100">
                                            برنامه هفته
                                            {{ jdate($program->start_date)->format('d %B Y') }}
                                        </div>
