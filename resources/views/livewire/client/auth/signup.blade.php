<div class="min-h-screen flex flex-col lg:flex-row bg-background p-0" x-data="signupForm()">
    ...
    <div class="lg:w-1/2 flex items-center justify-center p-6">
        <div class="w-full max-w-md">
            <div
                class="bg-gradient-to-b from-secondary to-background space-y-6 px-6 pb-6 rounded-3xl shadow-soft dark:shadow-soft-dark border border-border">

                <!-- Header -->
                <div class="bg-background rounded-b-3xl p-5 text-center">
                    <a wire:navigate href="{{route('client.home')}}"
                ...
                <div class="flex items-center justify-center mb-8 direction-rtl" dir="rtl">
                    <div
                        class="step-circle rounded-full flex items-center justify-center font-bold text-base {{ $currentStep >= 1 ? 'bg-primary text-primary-foreground active' : 'bg-secondary text-muted' }}">
                        @if($currentStep > 1)
                    ...
                    <div
                        class="step-circle rounded-full flex items-center justify-center font-bold text-base {{ $currentStep >= 2 ? 'bg-primary text-primary-foreground active' : 'bg-secondary text-muted' }}">
                        @if($currentStep > 2)
                            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                      d="M5 13l4 4L19 7"></path>
                    ...
                    <div
                        class="step-circle rounded-full flex items-center justify-center font-bold text-base {{ $currentStep >= 3 ? 'bg-primary text-primary-foreground active' : 'bg-secondary text-muted' }}">
                        3
                    </div>
                </div>
                    ...
                    <form wire:submit.prevent="goToStep2" class="space-y-5">
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="grid grid-cols-2 gap-3">
                                <label
                                    class="gender-option flex items-center justify-center gap-2 py-3 px-4 rounded-xl border border-border bg-secondary text-foreground">
                    ...
                    <form wire:submit.prevent="verifyAndRegister" class="space-y-5">
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="flex flex-wrap gap-3 text-xs mt-2">
                                <span
                                    class="password-strength-item flex items-center gap-1 {{ $passwordStrength['length'] ? 'active' : 'text-muted' }}">
                                    <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                                        <path fill-rule="evenodd"
                                ...
                                <span
                                    class="password-strength-item flex items-center gap-1 {{ $passwordStrength['letter'] ? 'active' : 'text-muted' }}">
                                    <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                                        <path fill-rule="evenodd"
                                              d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z"
                                              clip-rule="evenodd"></path>
                                ...
                                <span
                                    class="password-strength-item flex items-center gap-1 {{ $passwordStrength['number'] ? 'active' : 'text-muted' }}">
                                    <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                                        <path fill-rule="evenodd"
                                              d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z"
                                              clip-rule="evenodd"></path>
                        ...
                        <label class="flex items-start gap-3 text-sm text-foreground cursor-pointer">
                            <input type="checkbox" wire:model.defer="acceptTerms"
                                   class="mt-1 w-5 h-5 rounded border-border bg-secondary">
                        ...
                        <div class="grid grid-cols-2 gap-3">
                            ...
                            <button
                                ...
                                class="py-3 rounded-xl bg-primary text-primary-foreground font-medium hover:opacity-90 transition-all duration-300 flex items-center justify-center gap-2"
                            >
                                <span wire:loading.remove wire:target="verifyAndRegister"
                ...
                <div class="mt-6 text-center text-sm text-muted">
                    ...
                    <a wire:navigate href="{{ route('client.auth.login') }}"
                       class="font-medium text-primary hover:underline">وارد شوید</a>
                </div>
            </div>
        </div>
    </div>
