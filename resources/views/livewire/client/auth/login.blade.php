            ...
            <div class="train-border">
                <div class="glass-card rounded-3xl p-6 space-y-5">
                    ...
                    @if($loginMethod === 'otp')
                        ...
                        @else
                            <form wire:submit.prevent="verifyOtp" autocomplete="off" class="space-y-5" wire:key="otp-step-2">
                    ...
                    <div class="text-center text-sm text-muted">
                        ولی دانش‌آموز هستید؟
                        <a wire:navigate href="{{ route('client.parent.portal.login') }}" class="font-bold text-primary hover:underline mr-1">ورود به پنل والدین</a>
                    </div>
                </div>
            </div>
