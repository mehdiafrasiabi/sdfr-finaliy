                    ...
                    <div class="p-6">
                        ...
                        <div
                            ...
                            <p class="text-blue-800 dark:text-blue-400 text-sm">
                                پرداخت شما با موفقیت انجام شد. اکنون می‌توانید مشاور خود را انتخاب کنید.
                            </p>
                        </div>
                        <!-- Action Buttons -->
                        <div class="mt-6 flex flex-col space-y-3">
                            <a href="{{ route('client.profile.appointment') }}"
                               class="bg-green-600 hover:bg-green-700 dark:bg-green-700 dark:hover:bg-green-800 text-white py-3 px-4 rounded-lg font-medium text-center flex items-center justify-center transition-colors">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                     ...
                                     <path stroke-linecap="round" stroke-linejoin="round" d="M19 7.5l-5.44 4.945a3.75 3.75 0 01-5.12 0L3 7.5M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                                </svg>
                                انتخاب مشاور
                            </a>
