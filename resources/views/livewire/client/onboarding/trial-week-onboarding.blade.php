...
<div>
    @push('link')
        ...
        /* ═══ ANIMATED BORDER (the "high-speed train" effect) ═══ */
        .train-border {
            position: relative;
        ...
        .train-border::before {
            ...
            background: conic-gradient(
                ...
                transparent 0%,
                transparent 70%,
                hsl(var(--primary) / 0.9) 80%,
                #60a5fa 88%,
                hsl(var(--primary) / 0.9) 96%,
                transparent 100%
            );
            -webkit-mask:
    ...
    {{-- Lottie player (loaded via CDN) --}}
    <script src="/client/animation/lottie-player.js" defer></script>
...
@push('script')
    ...
    @php
        ...
        // Lottie animations from LottieFiles public CDN (CORS-friendly)
        $lottieWelcome = 'https://lottie.host/4d5d8a31-0d3c-46b2-9eb6-2f93b4c6f17d/yJxZqXNHLZ.lottie';
        $lottieOtp = 'https://lottie.host/f12fb47e-a4cf-43ac-8e98-5e3f5e6f8a4e/2zqAv9NCl8.lottie';
        $lottieSuccess = 'https://lottie.host/d0a9c2bd-d4e1-4f72-b97a-8b9c3e6f9c0d/9pqKZxXc8r.lottie';
    @endphp
                        ...
                        <div class="train-border">
                            <div class="glass-card rounded-3xl p-6 text-center">
                                <div class="inline-block w-36 h-36 mb-3">
                                    <lottie-player src="{{ $lottieWelcome }}"
                        ...
                        <div class="train-border">
                            <div class="glass-card rounded-3xl p-6">
                                <div class="text-center mb-6">
                                    <div class="inline-block w-28 h-28 mb-2">
                                        <lottie-player src="{{ $lottieSuccess }}"
            ...
            <div class="relative w-full max-w-sm"
                ...
                <div class="train-border">
                    <div class="glass-card rounded-2xl p-6 text-center">
                        ...
                        <div class="flex items-center gap-2">
                            <button type="button" @click="confirmTrialAction()" @mousedown="pressBtn($el)"
                                    :disabled="busy"
                            ...
                            <button type="button" @click="if (!busy) $wire.closeTrialConfirm()" @mousedown="pressBtn($el)"
