                 ...
                 dec() {
                     ...
                     if (v > 1) count = String(v - 1);
                                        ...
                                        <input type="number" min="1" id="calc_count"
                                               ...
                                               class="flex-1 min-w-0 w-full h-14 rounded-xl text-lg font-bold text-center transition-all focus:outline-none"
                                        ...
                                        <div class="grid sm:grid-cols-2 gap-3">
                                            <div class="space-y-1.5">
                                                ...
                                                <div wire:key="state-select">
                                                    <x-ui.select
                                                        ...
                                                        :options="collect($states)->toArray()"
                                            ...
                                            <div class="space-y-1.5">
                                                ...
                                                <div wire:key="city-select-{{ $state_id ?: 'none' }}">
                                                    <x-ui.select
                                                        wire:model="city_id"
                                                        :options="collect($cities)->toArray()"
                                                        :disabled="empty($state_id)"
                                                        :searchable="true"
                                                        :placeholder="empty($state_id) ? 'ابتدا استان را انتخاب کنید' : 'انتخاب شهر'"
                                                        name="city_id" />
                                                </div>
