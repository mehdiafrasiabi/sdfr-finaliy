<div>
    ...
    <style>
        ...
        .btn-brand:hover {
            ...
            box-shadow: 0 18px 42px -10px hsl(var(--primary) / .75);
        }
        ...
        .btn-ghost:hover {
            transform: translateY(-2px);
            border-color: hsl(var(--primary) / .6) !important;
        }
        ...
        .seam-top {
            top: 0;
            background: linear-gradient(to bottom, var(--seam-color, #000) 0%, transparent 100%);
        }

        .seam-bottom {
            bottom: 0;
            background: linear-gradient(to top, var(--seam-color, #000) 0%, transparent 100%);
        }
        ...
        .stamp-iran {
            ...
            animation: stampSlam 1s cubic-bezier(.2, .9, .25, 1.2) .25s both;
            filter: drop-shadow(0 8px 22px rgba(40, 102, 200, .35));
        }
        ...
        @keyframes stampSlam {
            0% {
                ...
                filter: blur(6px) drop-shadow(0 8px 22px rgba(40, 102, 200, .35));
            }
            55% {
                opacity: 1;
                transform: rotate(-7deg) scale(.92);
                filter: blur(0) drop-shadow(0 8px 22px rgba(40, 102, 200, .35));
            }
            70% {
        ...
        .swipe-hint {
            ...
            height: 62px;
            border-radius: 11px;
            border: 2px solid hsl(var(--primary) / .75);
        ...
        .swipe-hint::before {
            ...
            animation: swipeUp 1.9s cubic-bezier(.45, 0, .25, 1) infinite;
        }
        ...
        .swipe-hint::after {
            ...
            width: 11px;
            height: 11px;
            border: 2px solid hsl(var(--primary) / .55);
            border-radius: 50%;
            transform: translateX(-50%);
            animation: swipeRing 1.9s ease-out infinite;
        }
        ...
        .scroll-arrows svg {
            ...
            margin-top: -9px;
            opacity: 0;
            animation: cueArrow 1.8s infinite;
        }
        ...
        .story-brand {
            color: #38bdf8;
            text-shadow: 0 0 42px rgba(56, 189, 248, .55);
        }
        ...
        .feat-portal::after {
            content: 'گیف اینجا قرار می‌گیرد';
            font-weight: 800;
            font-size: 11px;
            color: rgba(195, 211, 240, .7);
        }
        ...
        .stars-deco img:nth-child(1) {
            animation-delay: 0s;
            animation-duration: 3.2s;
            margin-top: 16px;
        }

        .stars-deco img:nth-child(2) {
            animation-delay: .5s;
            animation-duration: 4.2s;
            margin-top: -8px;
        }

        .stars-deco img:nth-child(3) {
            animation-delay: 1.1s;
            animation-duration: 3.6s;
            margin-top: 12px;
        }

        .stars-deco img:nth-child(4) {
        ...
        .student-ava-wrap {
            ...
            justify-content: center;
            box-shadow: 0 12px 28px -10px hsl(var(--primary)/.7);
        }

        .student-ava-wrap img {
            width: 100%;
            height: 100%;
            object-fit: cover;
        ...
        .fp-bar {
            flex: 1;
            background: linear-gradient(180deg, hsl(var(--primary)), hsl(var(--primary)/.35));
        ...
        .price-card:hover {
            transform: translateY(-8px);
            box-shadow: 0 34px 70px -28px hsl(var(--primary) / .5);
            border-color: hsl(var(--primary) / .5) !important;
        }

        .price-card .price-ico-row li {
            transition: transform .25s;
        }

        .price-card:hover .price-ico-row li {
        ...
        .price-feat {
            animation: priceRing 3.2s ease-out infinite;
        }
        ...
        .btn-trial-glow::before {
            ...
            transform-origin: center;
            background: conic-gradient(from 0deg, transparent 0deg, transparent 200deg, #22d3ee 285deg, #38bdf8 325deg, #7dd3fc 350deg, transparent 360deg);
            animation: trialSpin 4.5s linear infinite;
            will-change: transform;
        ...
        /* ---------- Reduced motion ---------- */
        .reduce-motion .story-track, .reduce-motion .phone-track, .reduce-motion .logos-track, .reduce-motion .feat-track, .reduce-motion .price-intro-track {
            height: auto !important;
        }

        .reduce-motion .story-sticky, .reduce-motion .phone-sticky, .reduce-motion .logos-sticky, .reduce-motion .feat-sticky, .reduce-motion .price-intro-sticky {
            position: static !important;
            height: auto !important;
            padding-block: 3.5rem;
        }

        .reduce-motion .story-layer {
            position: relative;
            opacity: 1 !important;
            margin-block: 2rem;
        ...
        .reduce-motion .qa-q, .reduce-motion .qa-a {
            opacity: 1 !important;
            transform: none !important;
            filter: none !important;
        }

        .reduce-motion .feat-msg {
            position: relative;
            top: 0;
            opacity: 1 !important;
            filter: none !important;
        ...
        .reduce-motion .price-intro-title {
            opacity: 1 !important;
            filter: none !important;
            transform: none !important;
        }

        .reduce-motion .hero-stage {
            position: static;
            margin-top: 2rem;
            opacity: 1 !important;
        }

        .reduce-motion .logos-marq {
            position: static;
            opacity: .55 !important;
        }

        .reduce-motion .logos-veil {
            display: none;
        }

        .reduce-motion .feat-desktop {
            display: none !important;
        }

        .reduce-motion .feat-mobile {
            display: block !important;
        }

        .reduce-motion .sky-comets {
            display: none;
        }
        ...
        @media (max-width: 640px) {
            ...
            #story-help .sdfr-spark {
                font-size: clamp(62px, 23vw, 96px) !important;
                line-height: 1;
            }

            #story-help > span.font-medium {
            ...
            /* موبایل هم مثل دسکتاپ سه‌خطیِ عمودی باشد */
            .price-intro-line {
                display: flex;
                flex-direction: column;
                align-items: center;
        ...
        /* ===== (A3) مارکیِ دانش‌آموزان روی موبایل: دو ردیفِ خودکار که همیشه دیده می‌شوند ===== */
        @keyframes marqAutoLeft {
            from {
        ...
        @media (max-width: 767px) {
            ...
            #marq-top {
                animation: marqAutoLeft 32s linear infinite;
            }

            #marq-bottom {
                animation: marqAutoRight 32s linear infinite;
            }
        }
    </style>
    @endassets
    ...
    <div id="home-root" dir="rtl" class="relative">
        ...
        @php
            ...
            $students = [
                ...
                ['name'=>'سیده زهرا رشیدی', 'rank'=>'رتبه ۶۵ انسانی', 'uni'=>'حقوق تهران', 'gender'=>'girl'],
                ...
                ['name'=>'آناهیتا تقوی', 'rank'=>'رتبه ۴۰ تجربی', 'uni'=>'پزشکی تهران', 'gender'=>'girl'],
                ['name'=>'امیرعلی سارانی', 'rank'=>'رتبه ۲۵۰ ریاضی', 'uni'=>'برق شریف', 'gender'=>'boy'],
                ...
                ['name'=>'کیانوش سالاری', 'rank'=>'رتبه ۳۲۰ ریاضی', 'uni'=>'عمران شریف', 'gender'=>'boy'],
            ...
            <div class="hero-intro">
                ...
                <div class="inline-flex items-center gap-2 glass-home rounded-full px-4 py-2 mb-5">
                    <span class="relative flex w-2 h-2">
                        <span
                            class="absolute inline-flex w-full h-full bg-brand rounded-full opacity-75 animate-ping"></span>
                        ...
                        <div id="hero-phone" class="device">
                            ...
                            <div class="device-screen">
                                <div class="device-status">
                                    ...
                                    <span class="ic">
                                        <svg width="16" height="12" viewBox="0 0 18 12" fill="currentColor"><rect x="0"
                                                                                                                  y="7"
                                                                                                                  width="3"
                                                                                                                  height="5"
                                                                                                                  rx="1"/><rect
                                                x="5" y="4" width="3" height="8" rx="1"/><rect x="10" y="1.5" width="3"
                                                                                               height="10.5" rx="1"/><rect
                                                x="15" y="0" width="3" height="12" rx="1" opacity=".4"/></svg>
                                        <svg width="16" height="12" viewBox="0 0 16 12" fill="currentColor"><path
                                                d="M8 2.5c2.3 0 4.4.9 6 2.4l-1.4 1.5A6.6 6.6 0 0 0 8 4.6c-1.8 0-3.4.7-4.6 1.8L2 4.9A8.6 8.6 0 0 1 8 2.5Zm0 3.6c1.3 0 2.5.5 3.4 1.3L8 11 4.6 7.4A4.9 4.9 0 0 1 8 6.1Z"/></svg>
                                        <svg width="23" height="12" viewBox="0 0 26 12" fill="none"><rect x="1" y="1"
                                                                                                          width="21"
                                                                                                          height="10"
                                                                                                          rx="3"
                                                                                                          stroke="currentColor"
                                                                                                          stroke-opacity=".5"/><rect
                                                x="3" y="3" width="16" height="6" rx="1.5" fill="currentColor"/><rect
                                                x="23.5" y="4" width="1.5" height="4" rx=".75"
                                    ...
                                    <div id="phone-feed" class="feat-feed">
                                        @foreach($phoneFeatures as $i => $pf)
                                            <div class="feat-msg" data-i="{{ $i }}">
                                                <div class="feat-type">
                                                    <b>{{ $pf['big'] }}</b><span>{{ $pf['rest'] }}</span></div>
            ...
            <div id="logos-track" class="logos-track">
                <div class="logos-sticky">
                            ...
                            <div class="marq-row" id="marq-top">
                                @foreach($marqTopList as $st)
                                    <div class="student-card glass-home">
                                        ...
                                        <div class="student-meta"><span class="student-rank">{{ $st['rank'] }}</span>
                                        </div>
                    ...
                    <div id="logos-text" class="logos-text">
                        ...
                        <h2 class="font-black text-3xl md:text-5xl text-foreground"
                            style="text-shadow:0 4px 30px hsl(var(--background)),0 2px 10px hsl(var(--background));">
                            ستارگانِ منظومه‌ی SDFR</h2>
                        <p class="font-medium text-sm md:text-base text-muted mt-3 max-w-md mx-auto"
                           style="text-shadow:0 2px 14px hsl(var(--background));">دانش‌آموزانی که مسیرشان را با SDFR
                            رفتند و درخشیدند.</p>
                    </div>
                </div>
            </div>
        ...
        <section id="pricing" class="relative z-10">
            ...
            <div class="max-w-5xl mx-auto px-4 relative" style="margin-top:-8vh;">
                <div class="grid md:grid-cols-3 gap-5 items-stretch">
                    ...
                    <div
                        class="price-card price-feat glass relative rounded-3xl p-6 flex flex-col space-y-5 bg-brand-soft border-2 border-brand md:-translate-y-3 mt-3 md:mt-0 reveal-up rv-d1"
                        style="box-shadow:0 30px 60px -25px hsl(var(--primary)/.5);">
                        <div
                            class="absolute -top-3 left-1/2 -translate-x-1/2 inline-flex items-center bg-brand text-white font-black text-[11px] rounded-full px-4 py-1 shadow-lg">
                            پیشنهاد ویژه
                        </div>
                        <div class="space-y-1">
                        ...
                        <ul class="space-y-3 flex-1 price-ico-row">
                            @foreach(['همه‌ی امکانات پلتفرم','مشاور تخصصی اختصاصی','برنامه‌ی کاملاً شخصی‌سازی‌شده','آزمون‌های آنلاین نامحدود','کارنامه هوشمند با تحلیل و آنالیز روزانه'] as $it)
                                <li class="flex items-center gap-2.5">
                                    <span
                                        class="flex items-center justify-center w-5 h-5 bg-brand text-white rounded-md shrink-0">
                                        <svg class="w-3 h-3" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                             stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><path
                                                d="M20 6 9 17l-5-5"/></svg>
                                    </span>
                        ...
                        <div class="flex items-center gap-2 rounded-xl px-3 py-2.5"
                             style="background:hsl(var(--primary)/.10);border:1px solid hsl(var(--primary)/.25);">
                            <svg class="w-4 h-4 text-brand shrink-0" viewBox="0 0 24 24" fill="none"
                    ...
                    <div class="md:col-span-7">
                        <div class="glass rounded-3xl p-5 sm:p-6 md:p-8">
                            @if (session('contact_sent'))
                                <div class="mb-5 flex items-center gap-2 rounded-2xl px-4 py-3"
                                     style="background:rgba(16,185,129,.1);border:1px solid rgba(16,185,129,.3);color:#34d399;">
                            ...
                            <form wire:submit="submitContact" class="space-y-5">
                                <div class="grid sm:grid-cols-2 gap-5">
                                    <div class="space-y-2">
                                        ...
                                        <input type="text" wire:model="contact_name" placeholder="نام خود را وارد کن"
                                               class="field">
                                    ...
                                    <div class="space-y-2">
                                        ...
                                        <input type="tel" dir="ltr" wire:model="contact_phone" placeholder="09123456789"
                                ...
                                <div class="space-y-2">
                                    ...
                                    <textarea wire:model="contact_message" rows="5"
                                              placeholder="پیام خود را اینجا بنویس..." class="field"></textarea>
                                ...
                                <button type="submit" class="btn-brand w-full">
                                    ...
                                    <svg wire:loading.remove wire:target="submitContact" class="w-5 h-5"
            ...
            function initHome() {
                ...
                */
                ...
                function setPhone(p) {
                    ...
                    // چتِ معرفی حذف شده؛ حلقهٔ حباب‌ها فقط در صورت وجود اجرا می‌شود (بی‌اثر)
                    if (bubbles.length) {
                        var bP = clamp((p - 0.06) / 0.30, 0, 1);
                        var n = bubbles.length;
                        var show = Math.max(1, Math.min(n, Math.ceil(bP * n)));
                        bubbles.forEach(function (b, i) {
                            b.classList.toggle('shown', i < show);
                        });
                    }
                ...
                function setLogos(p) {
                    // موبایل: مارکیِ خودکارِ CSS اجرا می‌شود؛ JS دست نمی‌زند تا کارت‌ها همیشه دیده شوند
                ...
                function setFeatures(p) {
                    ...
                    accItems.forEach(function (it, i) {
                        it.classList.toggle('active', i === idx);
                    });
                    previews.forEach(function (pv, i) {
                        pv.classList.toggle('active', i === idx);
                    });
                }
                ...
                if (reduce) {
                    ...
                    qaRows.forEach(function (r) {
                        r.q.style.opacity = 1;
                        r.q.style.filter = 'none';
                        r.q.style.transform = 'none';
                        r.a.style.opacity = 1;
                        r.a.style.filter = 'none';
                    ...
                    if (phoneWhy) {
                        phoneWhy.style.opacity = 1;
                        phoneWhy.style.position = 'relative';
                        phoneWhy.style.top = 'auto';
                        phoneWhy.style.transform = 'none';
                        phoneWhy.style.marginBottom = '1.5rem';
                    }
                    if (phone) phone.style.transform = 'none';
                    bubbles.forEach(function (b) {
                        b.classList.add('shown');
                    });
                    featMsgs.forEach(function (m) {
                        m.style.opacity = 1;
                        m.style.filter = 'none';
                    ...
                    if (priceTitle) {
                        ...
                        priceTitle.style.filter = 'none';
                        priceTitle.style.transform = 'none';
                    }
