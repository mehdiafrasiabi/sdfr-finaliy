<div>
    <div class="space-y-8">
        ...
        <div class="relative">
            <div class="swiper latest-courses-swiper overflow-hidden">
                                    ...
                                    <a href="{{route('client.product',$item->p_code)}}/{{$item->seo->slug}}"
                                       class="block">
                                        <img src="/products/{{$item->id}}/photo/{{@$item->coverImage->path}}"
                                             class="w-full h-auto rounded-3xl" alt="{{$item->seo->slug}}"/>
                                    </a>
                                    <a href="{{route('client.product',$item->p_code)}}/{{$item->seo->slug}}"
                                        ...
                                        <div class="flex flex-wrap items-center gap-3">
                                            <div class="flex items-center gap-1 text-muted">
                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"
                                                    ...
                                                    <path
                                                        d="M7 3.5A1.5 1.5 0 0 1 8.5 2h3.879a1.5 1.5 0 0 1 1.06.44l3.122 3.12A1.5 1.5 0 0 1 17 6.622V12.5a1.5 1.5 0 0 1-1.5 1.5h-1v-3.379a3 3 0 0 0-.879-2.121L10.5 5.379A3 3 0 0 0 8.379 4.5H7v-1Z"></path>
                                                    <path
                                                        d="M4.5 6A1.5 1.5 0 0 0 3 7.5v9A1.5 1.5 0 0 0 4.5 18h7a1.5 1.5 0 0 0 1.5-1.5v-5.879a1.5 1.5 0 0 0-.44-1.06L9.44 6.439A1.5 1.5 0 0 0 8.378 6H4.5Z"></path>
                                                </svg>
            ...
            <div class="sm:hidden">
                <button
                    class="latest-courses-prev absolute right-2 top-1/2 -translate-y-1/2 z-10 w-10 h-10 flex items-center justify-center bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm rounded-full text-foreground shadow-lg transition-all hover:bg-primary hover:text-primary-foreground disabled:opacity-50 disabled:cursor-not-allowed">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="w-5 h-5">
                        <path fill-rule="evenodd"
                ...
                <button
                    class="latest-courses-next absolute left-2 top-1/2 -translate-y-1/2 z-10 w-10 h-10 flex items-center justify-center bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm rounded-full text-foreground shadow-lg transition-all hover:bg-primary hover:text-primary-foreground disabled:opacity-50 disabled:cursor-not-allowed">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="w-5 h-5">
                        <path fill-rule="evenodd"
    ...
    @push('script')
        <script>
            document.addEventListener('DOMContentLoaded', function () {
                const latestCoursesSwiper = new Swiper('.latest-courses-swiper', {
                    slidesPerView: 1,
                    spaceBetween: 20,
                    navigation: {
                        nextEl: '.latest-courses-next',
                        prevEl: '.latest-courses-prev',
                    },
                    breakpoints: {
                        640: {
                            slidesPerView: 2,
                    ...
                    // اضافه کردن loop برای چرخش بی‌نهایت
                    loop: true,
                    // اضافه کردن autoplay (اختیاری)
                    // autoplay: {
                    //     delay: 3000,
