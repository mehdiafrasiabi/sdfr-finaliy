<div>
    <div class="bg-gradient-to-l from-secondary to-background rounded-2xl p-5 space-y-8">
        ...
        <!-- ساختار درست Swiper -->
        <div id="unique-slider" class="swiper col3-swiper-slider">
            <div class="swiper-wrapper" id="students-container">

                @forelse($schoolSdfr as $item)
                    <div class="swiper-slide">
                        <div style="box-shadow: 0 7px 16px rgb(30 59 239 / 30%); display: inline-flex;">
                            <div class="relative mb-3 z-20">
                                <div class="block">
                                    <img src="{{ asset('client/sdfr/schoolSdfr/'.$item->document) }}"
