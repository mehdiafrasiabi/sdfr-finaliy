    ...
    <nav aria-label="Page navigation example">
        <ul class="pagination pagination-rounded pagination-success">
            ...
            <li class="page-item {{ $paginator->onFirstPage() ? 'disabled' : '' }}">
                ...
                @else
                    <a class="page-link" href="javascript:void(0);" aria-label="Previous" wire:click="previousPage"
                       rel="prev">
                        <i class="fi fi-rr-angle-double-right"></i>
                    </a>
                @endif
            ...
            <li class="page-item {{ $paginator->hasMorePages() ? '' : 'disabled' }}">
                @if ($paginator->hasMorePages())
                    <a class="page-link" href="javascript:void(0);" aria-label="Next" wire:click="nextPage" rel="next">
