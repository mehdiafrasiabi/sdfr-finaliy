document.getElementById("sa-basic") && document.getElementById("sa-basic").addEventListener("click", function () {
    ...
    Swal.fire({
        title: "<i>نمونه</i> <u>HTML</u>",
        icon: "info",
        html: 'شما می‌توانید از <b>متن پررنگ</b>، <a href="//mkhezerlou.ir/">لینک‌ها</a> و سایر تگ‌های HTML استفاده کنید',
        showCloseButton: !0,
        showCancelButton: !0,
        customClass: {confirmButton: "btn btn-success me-2", cancelButton: "btn btn-danger"},
        buttonsStyling: !1,
        confirmButtonText: '<i class="ri-thumb-up-fill align-bottom me-1"></i> عالیه!',
    ...
    Swal.fire({
        title: "ایمیل خود را برای اجرای درخواست ajax وارد کنید",
        input: "email",
        showCancelButton: !0,
        ...
        preConfirm: function (n) {
            return new Promise(function (t, e) {
                setTimeout(function () {
                    "taken@example.com" === n ? e("این ایمیل قبلاً استفاده شده است.") : t()
                }, 2e3)
            })
        },
        allowOutsideClick: !1
    ...
    Swal.fire({
        html: '<div class="mt-3"><lord-icon src="https://cdn.lordicon.com/lupuorrc.json" trigger="loop" colors="primary:#0ab39c,secondary:#405189" style="width:120px;height:120px"></lord-icon><div class="mt-4 pt-2 fs-15"><h4>کار عالی بود!</h4><p class="text-muted mx-4 mb-0">آفرین، شما با موفقیت این پیام مهم را خواندید.</p></div></div>',
        showCancelButton: !0,
        showConfirmButton: !1,
    ...
    Swal.fire({
        html: '<div class="mt-3"><lord-icon src="https://cdn.lordicon.com/tdrtiskw.json" trigger="loop" colors="primary:#f06548,secondary:#f7b84b" style="width:120px;height:120px"></lord-icon><div class="mt-4 pt-2 fs-15"><h4>اوه...! مشکلی پیش آمد!</h4><p class="text-muted mx-4 mb-0">آدرس ایمیل شما نامعتبر است</p></div></div>',
        showCancelButton: !0,
        showConfirmButton: !1,
        customClass: {cancelButton: "btn btn-primary w-xs mb-1"},
    ...
    Swal.fire({
        html: '<div class="mt-3"><lord-icon src="https://cdn.lordicon.com/gsqxdxog.json" trigger="loop" colors="primary:#f7b84b,secondary:#f06548" style="width:100px;height:100px"></lord-icon><div class="mt-4 pt-2 fs-15 mx-5"><h4>آیا مطمئن هستید؟</h4><p class="text-muted mx-4 mb-0">آیا مطمئن هستید که می‌خواهید این حساب را حذف کنید؟</p></div></div>',
        showCancelButton: !0,
        customClass: {confirmButton: "btn btn-primary w-xs me-2 mb-1", cancelButton: "btn btn-danger w-xs mb-1"},
    ...
    Swal.fire({
        title: "به جامعه ما بپیوندید",
        html: '<div class="mt-3 text-start"><label for="input-email" class="form-label fs-13">ایمیل</label><input type="email" class="form-control" id="input-email" placeholder="آدرس ایمیل را وارد کنید"></div>',
        imageUrl: "../../assets/images/logo-sm.png",
        footer: '<p class="fs-13 text-muted mb-0">قبلاً حساب کاربری دارید؟ <a href="#" class="fw-semibold text-decoration-underline">ورود</a></p>',
        imageHeight: 40,
        customClass: {confirmButton: "btn btn-primary w-xs mb-2"},
        confirmButtonText: 'ثبت نام <i class="ri-arrow-left-line ms-1 align-bottom"></i>',
        buttonsStyling: !1,
        showCloseButton: !0
    })
    ...
    Swal.fire({
        html: '<div class="mt-3"><div class="avatar-lg mx-auto"><div class="avatar-title bg-light text-success display-5 rounded-circle"><i class="ri-mail-send-fill"></i></div></div><div class="mt-4 pt-2 fs-15"><h4 class="fs-20 fw-semibold">ایمیل خود را تأیید کنید</h4><p class="text-muted mb-0 mt-3 fs-13">ما یک ایمیل تأیید به <span class="fw-medium text-dark">example@abc.com</span> ارسال کردیم، <br/> لطفاً آن را بررسی کنید.</p></div></div>',
        showCancelButton: !1,
        customClass: {confirmButton: "btn btn-primary mb-1"},
        confirmButtonText: "تأیید ایمیل",
        buttonsStyling: !1,
        footer: '<p class="fs-14 text-muted mb-0">ایمیلی دریافت نکردید؟ <a href="#" class="fw-semibold text-decoration-underline">ارسال مجدد</a></p>',
        showCloseButton: !0
    })
    ...
    Swal.fire({
        html: '<div class="mt-3"><div class="avatar-lg mx-auto"><img src="../../assets/images/users/avatar-2.jpg" class="rounded-circle img-thumbnail" alt="thumbnail"></div><div class="mt-4 pt-2 fs-15"><h4 class="fs-18 fw-semibold">خوش آمدید <span class="fw-semibold">مایک مایر</span></h4><p class="text-muted mb-0 fs-13">شما <span class="fw-semibold text-success">2</span> اعلان دارید</p></div></div>',
        showCancelButton: !1,
        customClass: {confirmButton: "btn btn-primary mb-1"},
        confirmButtonText: 'نمایش بده <i class="ri-arrow-left-line ms-1 align-bottom"></i>',
        buttonsStyling: !1,
        showCloseButton: !0
    })
});
