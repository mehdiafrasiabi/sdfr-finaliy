...
!function (e, t) {
    ...
    const o = {}, i = e => new Promise((t => {
        ...
        y = () => document.body.querySelector(`.${r.container}`), w = e => {
            const t = y();
            return t ? t.querySelector(e) : null
        }, v = e => w(`.${e}`), C = () => v(r.popup), A = () => v(r.icon), k = () => v(r.title),
        E = () => v(r["html-container"]), B = () => v(r.image), $ = () => v(r["progress-steps"]),
        P = () => v(r["validation-message"]), x = () => w(`.${r.actions} .${r.confirm}`),
        T = () => w(`.${r.actions} .${r.cancel}`), L = () => w(`.${r.actions} .${r.deny}`), S = () => w(`.${r.loader}`),
        O = () => v(r.actions), M = () => v(r.footer), j = () => v(r["timer-progress-bar"]), H = () => v(r.close),
        I = () => {
            const e = C();
            if (!e) return [];
    ...
    const ke = (e, t) => {
        ...
        }, xe = e => `<div class="${r["icon-content"]}">${e}</div>`, Te = (e, t) => {
            const n = t.showClass || {};
            ...
            ((e, t) => {
                ...
                if (n && o) {
                    ...
                    Y(o, "padding", t.padding), t.color && (o.style.color = t.color), t.background && (o.style.background = t.background), J(P()), Te(o, t)
                }
            })(0, t), pe(0, t), ((e, t) => {
                const n = $();
                if (!n) return;
    ...
    const ot = e => {
            ...
            o.swalCloseEventFinishedCallback = Qe.bind(null, e, n, i, s), t.addEventListener("animationend", (function (e) {
    ...
    const gt = e => {
        ...
        if (n.showLoaderOnDeny && lt(L()), n.preDeny) {
    ...
    const pn = ["swal-title", "swal-html", "swal-footer"], mn = e => {
        ...
        const n = y();
        t.removeEventListener("animationend", kn), n.style.overflowY = "auto"
    }, En = (e, t) => {
        ne(t) ? (e.style.overflowY = "hidden", t.addEventListener("animationend", kn)) : e.style.overflowY = "auto"
    }, Bn = (e, t, n) => {
        (() => {
    ...
    class On {
        constructor() {
            ...
            var r, a, l;
            this.params = s, this.isAwaitingPromise = !1, r = Sn, a = this, l = this._main(Ln.params), r.set(e(r, a), l)
        }
        ...
        _main(e) {
            ...
            o.currentInstance = Ln;
            const n = jn(e, t);
            Tn(n), Object.freeze(n), o.timeout && (o.timeout.stop(), delete o.timeout), clearTimeout(o.restoreFocusTimeout);
            const i = Hn(Ln);
            return Oe(Ln, n), me.innerParams.set(Ln, n), Mn(Ln, i, n)
        }
