    ...
    !function () {
        ...
        var e = function (t) {
                ...
                var i = s(n, e), o = t.initDate, a = t.options.maxDate, r = t.options.minDate, u = i.year, h = i.month,
                    d = i.day;
                return isNaN(u) || u < 1e3 || u > 1999 ? u = o.year : u < r.year ? (u = r.year, h = 1) : u > a.year && (u = a.year), isNaN(h) || h < 1 || h > 12 ? h = o.month : u <= r.year && h < r.month ? (h = r.month, d = 1) : u >= a.year && h > a.month && (h = a.month), isNaN(d) || d < 1 ? d = o.day : h <= r.month && d < r.day ? d = r.day : h >= a.month && d > a.day && (d = a.day), {
                    year: parseInt(u),
                    month: parseInt(h),
                    day: parseInt(d)
                }
            ...
            _ = "div.".concat(v, "-year"), b = "div.".concat(v, "-months"), T = "div.".concat(v, "-month"),
            C = "div.".concat(v, "-days"), x = "div.".concat(v, "-day"), I = "div.".concat(v, "-day.not-in-month"),
            S = "div.".concat(v, "-day.disabled-day"), M = "".concat(I, ".disabled-day"),
            E = "div.".concat(v, "-day-name"), A = "div.".concat(v, "-icon-plus"), O = "div.".concat(v, "-icon-minus"),
            j = "div.".concat(v, "-footer"), N = "div.".concat(v, "-btn-today"), B = "div.".concat(v, "-btn-empty"),
            P = "div.".concat(v, "-btn-close"), V = "div.".concat(v, "-time-container"), H = "div.".concat(v, "-time"),
            L = "not-in-range", k = "holly-day", Y = "".concat(v, ":change"), z = "click", R = "focusin", J = "keydown",
            W = "today", q = "attr", F = "data-jdp-only-date", X = "data-jdp-only-time",
            G = ("data-".concat(v), "visible"), K = "block", Q = "none", U = function t(n) {
                ...
                t && (t.dispatchEvent(Z(n)), n === Y && (t.dispatchEvent(Z("change")), t.dispatchEvent(Z("input"))))
                ...
                return u(function (t, n, e, o, a, r) {
                    for (var s = i(a, r) - i(n, e), u = t < o ? o : t, h = t < o ? t : o; h < u; h++) it(h) ? s += t < o ? 366 : -366 : s += t < o ? 365 : -365;
                    return s
                }(1392, 3, 25, t, n, e), 7)
            }, at = function (t, n) {
        ...
        var rt, st, ut = function (t, n) {
            ...
            var i = tt(H, n), o = tt("select", i, "change", (function (n) {
                var i, o, a;
            ...
            for (var a, r, u = (a = s({hour: 0, minute: 0, second: 0}, t.options.minTime), r = s({
                ...
                minute: 59,
                second: 59
            }, t.options.maxTime), "hour" == e ? ut(a.hour, r.hour) : "minute" == e ? a.hour == r.hour ? ut(a.minute, r.minute) : t.initTime.hour == a.hour ? ut(a.minute, 59) : t.initTime.hour == r.hour ? ut(0, r.minute) : ut(0, 59) : "second" == e ? a.hour == r.hour && a.minute == r.minute ? ut(a.second, r.second) : t.initTime.hour == a.hour && t.initTime.minute == a.minute ? ut(a.second, 59) : t.initTime.hour == r.hour && t.initTime.minute == r.minute ? ut(0, r.second) : ut(0, 59) : ut(a.second, r.second)), h = 0; h < u.length; h++) {
                var d = tt("option", o);
                d.value = u[h].toString(), d.text = et(u[h], t.options.persianDigits), d.selected = parseInt(u[h]) === parseInt(t.getValue[e] || t.initTime[e])
            }
        }, dt = function (t) {
            ...
            var e = tt(_, n);
            pt(t, n, !0);
            var i = t.options.useDropDownYears, o = tt(i ? "select" : "input", e, "keyup change", (function (n) {
            ...
            if (i) for (var a = function (t) {
                ...
                var s = tt("option", o);
                s.value = r, s.text = et(r, t.options.persianDigits), s.selected = r === t.initDate.year
            ...
            mt(t), function (t) {
                ...
                for (var o = function (t) {
                    ...
                    var s = tt("option", i);
                    s.value = o[r], s.text = et(a[o[r] - 1], t.options.persianDigits), s.selected = o[r] === t.initDate.month
                }
            }(t), function (t) {
                for (var n = tt(C, t.dpContainer), e = 0; e < 7; e++) tt(E + dt(e), n, null, null, et(t.options.days[e], t.options.persianDigits));
                for (var o = function (n) {
                    ...
                    a.inBeforeMonth = a.day <= f && e < f, a.inAfterMonth = e >= r + f, (a.inBeforeMonth || a.inAfterMonth) && (a.inBeforeMonth ? (v++, a.day = v, a.year = m, a.month = d) : (g++, a.day = g, a.year = l, a.month = c)), a.isValid = p(t, a.year, a.month, a.day), a.className = dt(ot(a.year, a.month, a.day)), t.inputValue.day === a.day && t.inputValue.year === a.year && t.inputValue.month === a.month && (a.className += ".".concat("selected")), t.today.day === a.day && t.today.year === a.year && t.today.month === a.month && (a.className += ".".concat("today")), i(t.options.dayRendering) && s(a, t.options.dayRendering(a, t.input)), a.isHollyDay && (a.className += ".".concat(k));
                    var u = a.isValid ? x : S;
            ...
            }), "انتخاب"), t.options.showEmptyBtn && tt(B, e, z, (function () {
                t.input.value = "", $(t.input, Y), t.options.hideAfterChange && t.hide()
            }), "خالی"), t.options.showCloseBtn && tt(P, e, z, (function () {
                t.hide()
            }), "بستن")
        }, ft = function (t) {
            nt(t.dpContainer, ""), t.options.date && lt(t), t.options.time && function (t) {
                var n = V + (t.options.time && !t.options.date ? ".jdp-only-time" : ""), e = tt(n, t.dpContainer);
            ...
            gt = {
                ...
                init: function (t) {
                    ...
                    this.updateOptions(t), Element.prototype.matches = Element.prototype.matchesSelector || Element.prototype.mozMatchesSelector || Element.prototype.msMatchesSelector || Element.prototype.oMatchesSelector || Element.prototype.webkitMatchesSelector, window.addEventListener("resize", (function () {
                        ...
                        var n, e, o;
                        gt.isShow && (n = gt.dpContainer, !((o = (e = t).path || e.composedPath && e.composedPath() || !1) ? -1 !== o.indexOf(n) : n.outerHTML.indexOf(e.target.outerHTML) > -1)) && function (t) {
                            try {
                ...
                isTransitioning: !1,
                get dpContainer() {
                    return this._dpContainer && this._dpContainer.isConnected || (this._dpContainer = tt(g, this.options.container), this.dpContainer.style.zIndex = this.options.zIndex), this.overlayElm && this.overlayElm.isConnected || (this.overlayElm = tt(D, this.options.container), this.overlayElm.style.zIndex = this.options.zIndex - 1), this._dpContainer
                },
                get today() {
                ...
                show: function (t) {
                    ...
                    }(t, this.options), this.isTransitioning = !0, this.dpContainer.style.visibility = G, this.dpContainer.style.display = K, this.overlayElm.style.display = K, setTimeout((function () {
                        n.dpContainer.style.visibility = G, n.dpContainer.style.display = K, n.overlayElm.style.display = K, n.isShow = !0, n.isTransitioning = !1
                    }), 300), this.setPosition(), function (t) {
                        U(t).addEventListener("scroll", (function () {
                            gt.setPosition()
                        }), {passive: !0})
                    }(t), document.addEventListener(J, _t)
                },
                hide: function () {
                    this.dpContainer.style.visibility = "hidden", this.dpContainer.style.display = Q, this.overlayElm.style.display = Q, this.isShow = !1, document.removeEventListener(J, _t)
                },
                ...
                return !e(gt.options._date) && e(t.date) && (t.date = gt.options._date), !e(gt.options._time) && e(t.time) && (t.time = gt.options._time), t.separatorChars = s(gt.options.separatorChars, t.separatorChars), (t = s({}, gt.options, t)).minDate === W && (t.minDate = a(gt.today)), t.maxDate === W && (t.maxDate = a(gt.today)), (t.initDate === q || t._initDateIsAttr) && (delete t.initDate, t._initDateIsAttr = !0, window.Object.defineProperty(t, "initDate", {
                    get: function () {
                        return Dt("data-jdp-init-date")
                    }, enumerable: !0
                })), (t.minDate === q || t._minDateIsAttr) && (delete t.minDate, t._minDateIsAttr = !0, window.Object.defineProperty(t, "minDate", {
                    get: function () {
                        return Dt("data-jdp-min-date")
                    }, enumerable: !0
                })), (t.maxDate === q || t._maxDateIsAttr) && (delete t.maxDate, t._maxDateIsAttr = !0, window.Object.defineProperty(t, "maxDate", {
                    get: function () {
                        return Dt("data-jdp-max-date")
                    }, enumerable: !0
                })), (t.minTime === q || t._minTimeIsAttr) && (delete t.minTime, t._minTimeIsAttr = !0, window.Object.defineProperty(t, "minTime", {
                    get: function () {
                        return Dt("data-jdp-min-time", !0)
                    }, enumerable: !0
                })), (t.maxTime === q || t._maxTimeIsAttr) && (delete t.maxTime, t._maxTimeIsAttr = !0, window.Object.defineProperty(t, "maxTime", {
                    get: function () {
        ...
        function _t(t) {
            var n, e;
            "Escape" === t.key && (gt.isTransitioning || (null === (n = gt.input) || void 0 === n || null === (e = n.blur) || void 0 === e || e.call(n), gt.hide()))
        }
